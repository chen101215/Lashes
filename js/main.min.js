    ...
    jQuery(".gform_wrapper select:not([multiple])").each(function() {
        ...
        setTimeout(function() {
            if (!a.siblings(".chosen-container").length) {
                ...
                a.parent().width(b),
                a.css("cssText", "width: 100% !important;"),
                jQuery('<div class="select-arrow">&#xe61f;</div>').appendTo(a.parent(".gravity-select-parent")),
...
function avadaAddWoocommerceQuantityBoxes(a) {
    ...
    }), jQuery(".plus, .minus").unbind("click"), jQuery(".plus, .minus").on("click",
    function() {
        ...
        jQuery(this).is(".plus") ? c && (c == b || b > c) ? a.val(c) : a.val(b + parseFloat(e)) : d && (d == b || d > b) ? a.val(d) : b > 0 && a.val(b - parseFloat(e)),
        a.trigger("change")
    }))
}
function fusionResizeCrossfadeImages(a) {
    ...
    a.find("img").each(function() {
        ...
        $img_height < b && jQuery(this).css("margin-top", (b - $img_height) / 2 + "px")
    })
}
...
function fusion_calc_woocommerce_tabs_layout(a) {
    jQuery(a).each(function() {
        ...
        jQuery(this).find("li").css("width", d + "px"),
        jQuery(this).find("li:last").css("width", e + "px").addClass("no-border-right")
    })
}
function _fusionRefreshScroll() {
    jQuery;
    _fusionScrollTop = window.pageYOffset,
    _fusionScrollLeft = window.pageXOffset
}
...
function _fbRowOnPlayerReady(a) {
    ...
    b.loopInterval = setInterval(function() {
        "undefined" != typeof b.loopTimeout && clearTimeout(b.loopTimeout),
        c == b.getCurrentTime() ? e = c + ( + new Date / 1e3 - d) : (e = b.getCurrentTime(), d = +new Date / 1e3),
        c = b.getCurrentTime(),
        e + (f ? .45 : .21) >= b.getDuration() && (b.pauseVideo(), b.seekTo(0), b.playVideo(), f = !1)
    },
    150)
}
...
function onYouTubeIframeAPIReady() {
    for (var a = _fbRowGetAllElementsWithAttribute("data-youtube-video-id"), b = 0; b < a.length; b++) {
        for (var c = a[b].getAttribute("data-youtube-video-id"), d = "", e = 0; e < a[b].childNodes.length; e++) if (/div/i.test(a[b].childNodes[e].tagName)) {
        ...
        if ("" !== d) {
            ...
            "yes" === a[b].getAttribute("data-mute") ? f.isMute = !0 : f.isMute = !1,
            "true" === a[b].getAttribute("data-youtube-video-id") && f.setPlaybackQuality("hd720"),
            setTimeout(function() {
...
function add_styles_for_old_ie_versions() {
    ...
    "11.0" == cssua.ua.ie && jQuery("head").append('<style type="text/css">.layout-boxed-mode .fusion-footer-parallax { left: auto; right: auto; }</style>')
}
function get_adminbar_height() {
    var a = 0;
    return jQuery("#wpadminbar").length && (a = parseInt(jQuery("#wpadminbar").outerHeight())),
    a
}
function get_sticky_header_height() {
    ...
    return (jQuery(".fusion-header-v4").length || jQuery(".fusion-header-v5").length) && (a = 2),
    "1" == js_local_vars.header_sticky && jQuery(".fusion-header-wrapper").length && (1 == a ? (b = jQuery(".fusion-header").outerHeight() - 1, 64 > b && (b = 64)) : (b = jQuery(".fusion-secondary-main-menu").outerHeight(), "menu_and_logo" == js_local_vars.header_sticky_type2_layout && (b += jQuery(".fusion-header").outerHeight())), Modernizr.mq("only screen and (max-width: " + js_local_vars.side_header_break_point + "px)") && ("1" == js_local_vars.header_sticky_mobile ? (jQuery(".fusion-mobile-menu-design-classic").length && (b = jQuery(".fusion-secondary-main-menu").outerHeight()), jQuery(".fusion-mobile-menu-design-modern").length && (b = jQuery(".fusion-header").outerHeight())) : b = 0), "1" != js_local_vars.header_sticky_tablet && c && (b = 0)),
    b
}
...
function insertParam(a, b, c, d) {
    ...
    g = "";
    if (f.length > 1) for (var h = f[1].split("&"), i = 0; i < h.length; i++) {
        var j = h[i].split("=");
        replaceDuplicates && j[0] == b || ("" === g ? g = "?" + j[0] + "=" + (j[1] ? j[1] : "") : (g += "&", g += j[0] + "=" + (j[1] ? j[1] : "")))
    }
    return "" === g && (g = "?"),
    d ? g = "?" + b + "=" + c + (g.length > 1 ? "&" + g.substring(1) : "") : ("" !== g && "?" != g && (g += "&"), g += b + "=" + (c ? c: "")),
    f[0] + g + urlhash
}
...
function onPlayerStateChange(a, b) {
    return function(a) {
        a.data == YT.PlayerState.PLAYING && jQuery(b).flexslider("pause"),
        a.data == YT.PlayerState.PAUSED && jQuery(b).flexslider("play"),
        a.data == YT.PlayerState.BUFFERING && jQuery(b).flexslider("pause"),
        a.data == YT.PlayerState.ENDED && "1" == jQuery(b).data("autoplay") && jQuery(b).flexslider("play")
    }
}
...
function playVideoAndPauseOthers(a) {
    ...
    d.length && (!d.parents("li").hasClass("clone") && d.parents("li").hasClass("flex-active-slide") && "yes" == d.parents("li").attr("data-autoplay") && window.$youtube_players[d.attr("id")].playVideo(), "yes" == c.attr("data-mute") && window.$youtube_players[d.attr("id")].mute()),
...
function(a) {
    ...
    b.prototype.activate = function(b) {
        ...
        f.parent(".sub-menu").length && (f = f.closest("li.fusion-dropdown-menu").addClass("current-menu-item")),
        f.trigger("activate.bs.scrollspy")
    },
    b.prototype.clear = function() {
        a(this.selector).parentsUntil(this.options.target, ".current-menu-item").removeClass("current-menu-item"),
        a(this.selector).parentsUntil(this.options.target, ".current-menu-parent").removeClass("current-menu-parent")
    };
...
function(a) {
    ...
    jQuery("click.bs.collapse.data-api, [data-toggle=collapse]").each(function() {
        ...
        if (0 == jQuery(this).parents(".panel-group").length) {
            ...
            jQuery(this).attr("data-parent", "accordian-" + a),
            jQuery(b).wrap('<div class="accordian fusion-accordian fusion-single-accordian"><div class="panel-group" id="accordion-' + a + '"></div></div>')
        }
    })
} (jQuery),
+
...
function(a) {
    ...
    b.prototype.activate = function(b, c, d) {
        function e() {
            ...
            b.addClass("active"),
            b.parent(".nav-tabs").length && b.parents(".fusion-tabs").find(".nav").find('a[href="' + b.find("a").attr("href") + '"]').parent().addClass("active"),
    ...
    c.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            f.detach().css({
                ...
                left: 0,
                display: "block"
            }).addClass(h).data("bs." + this.type, this).addClass(this.$element.data("class")),
...
var cssua = function(a, b, c) {
    ...
    m = {
        parse: function(a, b) {
            ...
            for (var d, m, n = a.split(/[()]/), o = 0, p = n.length; p > o; o++) if (o % 2) {
                var q = n[o].split(";");
                for (d = 0, m = q.length; m > d; d++) if (e.exec(q[d])) {
                    var r = RegExp.$1.split(" ").join("_"),
                    s = RegExp.$2; (!c[r] || parseFloat(c[r]) < parseFloat(s)) && (c[r] = s)
                }
            } else {
                var t = n[o].match(f);
                if (t) for (d = 0, m = t.length; m > d; d++) {
                    var u = t[d].split(/[\/\s]+/);
                    u.length && "mozilla" !== u[0] && (c[u[0].split(" ").join("_")] = u.slice(1).join("-"))
                }
            }
            if (k.exec(a)) c.mobile = RegExp.$1,
            g.exec(a) && (delete c[c.mobile], c.blackberry = c.version || RegExp.$3 || RegExp.$2 || RegExp.$1, RegExp.$1 ? c.mobile = "blackberry": "0.0.1" === c.version && (c.blackberry = "7.1.0.0"));
            ...
            return c.intel_mac_os_x ? (c.mac_os_x = c.intel_mac_os_x.split("_").join("."), delete c.intel_mac_os_x) : c.cpu_iphone_os ? (c.ios = c.cpu_iphone_os.split("_").join("."), delete c.cpu_iphone_os) : c.cpu_os ? (c.ios = c.cpu_os.split("_").join("."), delete c.cpu_os) : "iphone" !== c.mobile || c.ios || (c.ios = "1"),
            c.opera && c.version ? (c.opera = c.version, delete c.blackberry) : h.exec(a) ? c.silk_accelerated = !0 : i.exec(a) && (c.fluidapp = c.version),
            c.applewebkit ? (c.webkit = c.applewebkit, delete c.applewebkit, c.opr && (c.opera = c.opr, delete c.opr, delete c.chrome), c.safari && (c.chrome || c.crios || c.opera || c.silk || c.fluidapp || c.phantomjs || c.mobile && !c.ios ? delete c.safari: c.version && !c.rim_tablet_os ? c.safari = c.version: c.safari = {
                419 : "2.0.4",
                417 : "2.0.3",
                416 : "2.0.2",
                412 : "2.0",
        ...
        format: function(a) {
            function b(a, b) {
                ...
                if ("string" == typeof b) {
                    ...
                    for (var e = b.indexOf("-"); e > 0;) c += d + a + "-" + b.substring(0, e),
                    e = b.indexOf("-", e + 1);
                    c += d + a + "-" + b
                }
                return c
    ...
    return a.className ? a.className = a.className.replace(/\bno-js\b/g, "") + n: a.className = n.substr(1),
    m
...
function() {
    ...
    y = {
        ...
        init_: function(a) {
            ...
            try {
                ...
                b = document.styleSheets[document.styleSheets.length - 1],
                b.cssText += "\r\n" + c
            }
    ...
    C.drawImage = function(a, b) {
        ...
        var m = a.width,
        n = a.height;
        if (a.runtimeStyle.width = k, a.runtimeStyle.height = l, 3 == arguments.length) c = arguments[1],
        d = arguments[2],
        g = h = 0,
        i = e = m,
        j = f = n;
        ...
        if (r.push(" <g_vml_:group", ' coordsize="', v * s, ",", v * t, '"', ' coordorigin="0,0"', ' style="width:', s, "px;height:", t, "px;position:absolute;"), 1 != this.m_[0][0] || this.m_[0][1]) {
            ...
            w.x = p.max(w.x, x.x, y.x, z.x),
            w.y = p.max(w.y, x.y, y.y, z.y),
            r.push("padding:0 ", q(w.x / v), "px ", q(w.y / v), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", u.join(""), ", sizingmethod='clip');")
        } else r.push("top:", q(o.y / v), "px;left:", q(o.x / v), "px;");
        r.push(' ">', '<g_vml_:image src="', a.src, '"', ' style="width:', v * e, "px;", " height:", v * f, 'px;"', ' cropleft="', g / m, '"', ' croptop="', h / n, '"', ' cropright="', (m - g - i) / m, '"', ' cropbottom="', (n - h - j) / n, '"', " />", "</g_vml_:group>"),
    ...
    C.stroke = function(a) {
        ...
        if (b.push(' ">'), a) if ("object" == typeof this.fillStyle) {
            ...
            for (var I = H.length,
            J = H[0].color, K = H[I - 1].color, L = H[0].alpha * this.globalAlpha, M = H[I - 1].alpha * this.globalAlpha, N = [], l = 0; I > l; l++) {
                var O = H[l];
            ...
            1 > P && (e *= P),
            b.push("<g_vml_:stroke", ' opacity="', e, '"', ' joinstyle="', this.lineJoin, '"', ' miterlimit="', this.miterLimit, '"', ' endcap="', i(this.lineCap), '"', ' weight="', P, 'px"', ' color="', d, '" />')
        }
        b.push("</g_vml_:shape>"),
...
var Froogaloop = function() {
    ...
    function g(a) {
        ...
        for (var b = a.split("/"), c = "", d = 0, e = b.length; e > d && 3 > d; d++) c += b[d],
        2 > d && (c += "/");
        return c
    }
    function h(a) {
    ...
    return a.fn = a.prototype = {
        ...
        init: function(a) {
            ...
            this.element = a,
            k = g(this.element.getAttribute("src")),
            this
        },
        api: function(a, c) {
        ...
        addEvent: function(a, c) {
            ...
            g = "" !== f.id ? f.id: null;
            return d(a, c, g),
            "ready" != a ? b("addEventListener", a, f) : "ready" == a && j && c.call(null, g),
            e
        },
...
function() {
    ...
    function f(b) {
        if (e(), "string" == typeof b && (b = document.querySelector(b)), b && "object" == typeof b && b.nodeType) {
            ...
            for (var k = h.isBorderBox = "border-box" == f.boxSizing,
            l = 0; j > l; l++) {
                var m = i[l],
                n = f[m],
                o = parseFloat(n);
...
function(a, b) {
    "function" == typeof define && define.amd ? define(["outlayer/outlayer", "get-size/get-size", "desandro-matches-selector/matches-selector", "fizzy-ui-utils/utils", "./item", "./layout-mode", "./layout-modes/masonry", "./layout-modes/fit-rows", "./layout-modes/vertical"],
    ...
    function c(b, c) {
        function C(b) {
            if (! (ja() || a(b.target).closest(c.excludedElements, Sa).length > 0)) {
                ...
                Ra = ra(),
                ha(),
                !y || Ua === c.fingers || c.fingers === s || R() ? (la(0, f), Wa = Aa(), 2 == Ua && (la(1, e.touches[1]), Ma = Na = ua(Va[0].start, Va[1].start)), (c.swipeStatus || c.pinchStatus) && (d = J(e, Ta))) : d = !1,
                d === !1 ? (Ta = x, J(e, Ta), d) : (c.hold && (ab = setTimeout(a.proxy(function() {
        ...
        function K(b, j, k) {
            ...
            this), c.doubleTapThreshold)) : ($a = null, Sa.trigger("tap", [b.target]), c.tap && (q = c.tap.call(Sa, b, b.target)))) : k == o ? (j === x || j === w) && (clearTimeout(_a), $a = null, Sa.trigger("doubletap", [b.target]), c.doubleTap && (q = c.doubleTap.call(Sa, b, b.target))) : k == p && (j === x || j === w) && (clearTimeout(_a), $a = null, Sa.trigger("longtap", [b.target]), c.longTap && (q = c.longTap.call(Sa, b, b.target))),
            q
        }
        function L() {
            var a = !0;
        ...
        function ka(a) {
            a === !0 ? (Sa.bind(Fa, D), Sa.bind(Ga, E), Ha && Sa.bind(Ha, G)) : (Sa.unbind(Fa, D, !1), Sa.unbind(Ga, E, !1), Ha && Sa.unbind(Ha, G, !1)),
...
function($) {
    ...
    function go_complementAutoObject(a, b) {
        ...
        is_number(b.timeoutDuration) || (b.timeoutDuration = b.duration < 10 ? 2500 : 5 * b.duration),
    ...
    function sz_setSizes(a, b) {
        ...
        b.centerVertically && a.css("line-height", f.height + "px"),
        f
    }
    ...
    function cf_getItemAdjustMinMax(a, b) {
        return is_number(b.min) && a < b.min && (a = b.min),
    ...
    $.fn.carouFredSel || ($.fn.caroufredsel = $.fn.carouFredSel = function(options, configs) {
        ...
        FN._bind_events = function() {
            ...
            function(a, b, c) {
                ...
                if (opts.circular || itms.total - c < itms.first && (c = itms.total - itms.first), opts.items.visibleConf.old = opts.items.visible, opts.items.visibleConf.variable) {
                    ...
                    opts.items.visible + c <= f && c < itms.total && (c++, f = cf_getItemsAdjust(gn_getVisibleItemsNext(d, opts, itms.total - c), opts, opts.items.visibleConf.adjust, $tt0)),
            ...
            function(a, b, c) {
                ...
                if (opts.items.visibleConf.old = opts.items.visible, opts.items.visibleConf.variable) {
                    for (var g = cf_getItemsAdjust(gn_getVisibleItemsNextTestCircular(d, opts, c, f), opts, opts.items.visibleConf.adjust, $tt0); opts.items.visible - c >= g && c < itms.total;) c++,
            ...
            function(a, b, c, d, e, f, g) {
                ...
                0 == b ? !1 : (is_object(e) || (e = !1), "prev" != f && "next" != f && (f = opts.circular ? b <= itms.total / 2 ? "next": "prev": 0 == itms.first || itms.first > b ? "next": "prev"), "prev" == f && (b = itms.total - b), $cfs.trigger(cf_e(f, conf), [e, b, g]), !0)
            }),
            ...
            function(a, b, c, d, e) {
                ...
                "end" == i || d || c < itms.first && (itms.first += b.length),
            ...
            function(a, b, c, d) {
                ...
                c = g[1],
                d = g[2];
                if (b instanceof $ && b.length > 1) return h = $(),
                b.each(function(a, b) {
        ...
        FN._unbind_buttons = function() {
            ...
            opts.pagination.container && (opts.pagination.container.unbind(a), opts.pagination.anchorBuilder && opts.pagination.container.children().remove()),
    ...
    a.fn.countTo = function(b) {
        ...
        a(this).each(function() {
            function c() {
                ...
                j >= f && (i.removeData("countTo"), clearInterval(l.interval), k = e.to, "function" == typeof e.onComplete && e.onComplete.call(h, k))
            }
            function d(a) {
...
function(a) {
    a.fn.countDown = function(b) {
        ...
        a("#" + a(this).attr("id") + " .fusion-digit").html('<div class="top"></div><div class="bottom"></div>'),
    ...
    a.fn.setCountDown = function(b) {
        ...
        return diffSecs = Math.floor((c.valueOf() - d.valueOf()) / 1e3),
        a.data(this[0], "diffSecs", diffSecs),
        diffSecs
    },
    a.fn.doCountDown = function(b, c, d) {
        $this = a("#" + b),
        0 >= c && (c = 0, $this.data("timer") && clearTimeout($this.data("timer"))),
        secs = c % 60,
        mins = Math.floor(c / 60) % 60,
        hours = Math.floor(c / 60 / 60) % 24,
        1 == $this.data("omitWeeks") ? (days = Math.floor(c / 60 / 60 / 24), weeks = Math.floor(c / 60 / 60 / 24 / 7)) : (days = Math.floor(c / 60 / 60 / 24) % 7, weeks = Math.floor(c / 60 / 60 / 24 / 7)),
        days > 99 && $this.find(".fusion-dash-days").find(".fusion-first-digit").css("display", "inline-block"),
        $this.dashChangeTo(b, "fusion-dash-seconds", secs, d ? d: 800),
        $this.dashChangeTo(b, "fusion-dash-minutes", mins, d ? d: 1200),
        $this.dashChangeTo(b, "fusion-dash-hours", hours, d ? d: 1200),
        $this.dashChangeTo(b, "fusion-dash-days", days, d ? d: 1200),
        $this.dashChangeTo(b, "fusion-dash-weeks", weeks, d ? d: 1200),
        a.data($this[0], "diffSecs", c),
        c > 0 ? (e = $this, t = setTimeout(function() {
            e.doCountDown(b, c - 1)
        },
    ...
    a.fn.dashChangeTo = function(b, c, d, e) {
        ...
        for (var f = $this.find("." + c + " .fusion-digit").length - 1; f >= 0; f--) {
            var g = d % 10;
            d = (d - g) / 10,
            $this.digitChangeTo("#" + $this.attr("id") + " ." + c + " .fusion-digit:eq(" + f + ")", g, e)
        }
    },
    a.fn.digitChangeTo = function(b, c, d) {
        ...
        f = a(b + " div.bottom");
        d || (d = 800),
        e.html() != c + "" && e.not(":animated").length && (e.css({
            display: "none"
        }), e.html(c ? c: "0").fadeOut(d,
        function() {
            f.html(e.html()),
            f.css({
                display: "block",
...
function(a, b) {
    ...
    function f(c, f, g) {
        function i(b, c, e) {
            if (!b && c === !0) {
                ...
                if (!f) return d("options not found, can not resume"),
                !1;
        ...
        if (c.cycleStop === b && (c.cycleStop = 0), (f === b || null === f) && (f = {}), f.constructor == String) {
            ...
            case "toggle":
                return c.cyclePause = 1 === c.cyclePause ? 0 : 1,
                i(c.cyclePause, g, c),
                e(c),
                !1;
            case "pause":
    ...
    function h(b, c) {
        ...
        (c.pager || c.pagerAnchorBuilder) && a.each(c.pagerAnchors || [],
        function() {
            this.unbind().remove()
        }),
        c.pagerAnchors = null,
    ...
    function i(c, f, h, i, n) {
        var r, s = a.extend({},
        a.fn.cycle.defaults, i || {},
        a.metadata ? c.metadata() : a.meta ? c.data() : {}),
        t = a.isFunction(c.data) ? c.data(s.metaAttr) : null;
        t && (s = a.extend(s, t)),
        s.autostop && (s.countdown = s.autostopCount || h.length);
        var u = c[0];
        if (c.data("cycle.opts", s), s.$cont = c, s.stopCount = u.cycleStop, s.elements = h, s.before = s.before ? [s.before] : [], s.after = s.after ? [s.after] : [], !a.support.opacity && s.cleartype && s.after.push(function() {
            ...
            }), r) for (var w = 0; w < h.length; w++) s.startingSlide == s.randomMap[w] && (s.randomIndex = w);
            else s.randomIndex = 1,
        ...
        f.css({
            ...
            var c;
            c = s.backwards ? x ? x >= b ? h.length + (b - x) : x - b: h.length - b: x ? b >= x ? h.length - (b - x) : x - b: h.length - b,
            a(this).css("z-index", c)
        }),
        a(h[x]).css("opacity", 1).show(),
        g(h[x], s),
        s.fit && (s.aspect ? f.each(function() {
            var b = a(this),
        ...
        }) : (s.width && f.width(s.width), s.height && "auto" != s.height && f.height(s.height))),
        !s.center || s.fit && !s.aspect || f.each(function() {
            var b = a(this);
            b.css({
        ...
        var G = !1;
        if (s.pause && c.bind("mouseenter.cycle",
        function() {
            G = !0,
            this.cyclePause++,
            e(u, !0)
        }).bind("mouseleave.cycle",
        function() {
            G && this.cyclePause--,
            e(u, !0)
        }), k(s) === !1) return ! 1;
        ...
        if (i.requeueAttempts = i.requeueAttempts || 0, f.each(function() {
            ...
            if (this.cycleH = s.fit && s.height ? s.height: b.height() || this.offsetHeight || this.height || b.attr("height") || 0, this.cycleW = s.fit && s.width ? s.width: b.width() || this.offsetWidth || this.width || b.attr("width") || 0, b.is("img")) {
                ...
                if (c) {
                    if (n.s && s.requeueOnImageNotLoaded && ++i.requeueAttempts < 100) return d(i.requeueAttempts, " - img slide not loaded, requeuing slideshow: ", this.src, this.cycleW, this.cycleH),
                    setTimeout(function() {
                        a(n.s, n.c).cycle(i)
                    },
                    s.requeueTimeout),
        ...
        if (s.cssBefore = s.cssBefore || {},
        s.cssAfter = s.cssAfter || {},
        s.cssFirst = s.cssFirst || {},
        s.animIn = s.animIn || {},
        s.animOut = s.animOut || {},
        f.not(":eq(" + x + ")").css(s.cssBefore), a(f[x]).css(s.cssFirst), s.timeout) {
        ...
        if (s.easing && (s.easeIn = s.easeOut = s.easing), s.speedIn || (s.speedIn = s.speed), s.speedOut || (s.speedOut = s.speed), s.slideCount = h.length, s.currSlide = s.lastSlide = x, s.random ? (++s.randomIndex == h.length && (s.randomIndex = 0), s.nextSlide = s.randomMap[s.randomIndex]) : s.backwards ? s.nextSlide = 0 === s.startingSlide ? h.length - 1 : s.startingSlide - 1 : s.nextSlide = s.startingSlide >= h.length - 1 ? 0 : s.startingSlide + 1, !s.multiFx) {
            ...
            else if ("custom" != s.fx && !s.multiFx) return d("unknown transition: " + s.fx, "; slideshow terminating"),
            !1
        }
        var K = f[x];
        return s.skipInitializationCallbacks || (s.before.length && s.before[0].apply(K, [K, K, s, !0]), s.after.length && s.after[0].apply(K, [K, K, s, !0])),
        s.next && a(s.next).bind(s.prevNextEvent,
        function() {
            return o(s, 1)
        }),
        s.prev && a(s.prev).bind(s.prevNextEvent,
        function() {
            return o(s, 0)
        }),
        (s.pager || s.pagerAnchorBuilder) && p(h, s),
        l(s, h),
        s
    }
    function j(b) {
        ...
        b.original.cssBefore = a.extend({},
        b.cssBefore),
        b.original.cssAfter = a.extend({},
        b.cssAfter),
        b.original.animIn = a.extend({},
        b.animIn),
        b.original.animOut = a.extend({},
        b.animOut),
        a.each(b.before,
        function() {
    ...
    function k(b) {
        ...
        if (b.fx.indexOf(",") > 0) {
            for (b.multiFx = !0, b.fxs = b.fx.replace(/\s*/g, "").split(","), e = 0; e < b.fxs.length; e++) {
                var h = b.fxs[e];
                f = g[h],
                f && g.hasOwnProperty(h) && a.isFunction(f) || (d("discarding unknown transition: ", h), b.fxs.splice(e, 1), e--)
            }
            if (!b.fxs.length) return d("No valid transitions named; slideshow terminating."),
            !1
        } else if ("all" == b.fx) {
            b.multiFx = !0,
            b.fxs = [];
    ...
    function l(b, c) {
        b.addSlide = function(d, e) {
            ...
            b.random && (b.randomMap.push(b.slideCount - 1), b.randomMap.sort(function(a, b) {
                return Math.random() - .5
            })),
            f.css("position", "absolute"),
            f[e ? "prependTo": "appendTo"](b.$cont),
            e && (b.currSlide++, b.nextSlide++),
            a.support.opacity || !b.cleartype || b.cleartypeNoBg || q(f),
    ...
    function m(d, e, f, g) {
        function h() {
            var a = 0;
            e.timeout;
            e.timeout && !e.continuous ? (a = n(d[e.currSlide], d[e.nextSlide], e, g), "shuffle" == e.fx && (a -= e.speedOut)) : e.continuous && i.cyclePause && (a = 10),
            a > 0 && (i.cycleTimeout = setTimeout(function() {
                m(d, e, 0, !e.backwards)
            },
            a))
        }
        ...
        if (i.cycleStop == e.stopCount && (0 !== i.cycleTimeout || f)) {
            ...
            if (!f && i.cyclePause || e.nextSlide == e.currSlide) h();
                ...
                k.cycleH = k.cycleH || a(k).height(),
                k.cycleW = k.cycleW || a(k).width(),
                e.multiFx && (g && (e.lastFx === b || ++e.lastFx >= e.fxs.length) ? e.lastFx = 0 : !g && (e.lastFx === b || --e.lastFx < 0) && (e.lastFx = e.fxs.length - 1), o = e.fxs[e.lastFx]),
                e.oneTimeFx && (o = e.oneTimeFx, e.oneTimeFx = null),
                a.fn.cycle.resetState(e, o),
                e.before.length && a.each(e.before,
                function(a, b) {
                ...
                c("tx firing(" + o + "); currSlide: " + e.currSlide + "; nextSlide: " + e.nextSlide),
                e.busy = 1,
                e.fxFn ? e.fxFn(j, k, e, p, g, f && e.fastOnEvent) : a.isFunction(a.fn.cycle[e.fx]) ? a.fn.cycle[e.fx](j, k, e, p, g, f && e.fastOnEvent) : a.fn.cycle.custom(j, k, e, p, g, f && e.fastOnEvent)
            }
            if (l || e.nextSlide == e.currSlide) {
                var q;
                e.lastSlide = e.currSlide,
                e.random ? (e.currSlide = e.nextSlide, ++e.randomIndex == d.length && (e.randomIndex = 0, e.randomMap.sort(function(a, b) {
                    return Math.random() - .5
    ...
    function o(b, c) {
        ...
        f = b.$cont[0],
        g = f.cycleTimeout;
        if (g && (clearTimeout(g), f.cycleTimeout = 0), b.random && 0 > d) b.randomIndex--,
        -2 == --b.randomIndex ? b.randomIndex = e.length - 2 : -1 == b.randomIndex && (b.randomIndex = e.length - 1),
    ...
    a.fn.cycle.resetState = function(b, c) {
        ...
        b.before = [],
        b.after = [],
        b.cssBefore = a.extend({},
        b.original.cssBefore),
        b.cssAfter = a.extend({},
        b.original.cssAfter),
        b.animIn = a.extend({},
        b.original.animIn),
        ...
        b.original.animOut),
        b.fxFn = null,
        a.each(b.original.before,
        function() {
            b.before.push(this)
        }),
        a.each(b.original.after,
        function() {
            b.after.push(this)
        });
    ...
    a.fn.cycle.createPagerAnchor = function(b, d, f, g, h) {
        ...
        if (a.isFunction(h.pagerAnchorBuilder) ? (i = h.pagerAnchorBuilder(b, d), c("pagerAnchorBuilder(" + b + ", el) returned: " + i)) : i = '<a href="#"></a>', i) {
            ...
            /mouseenter|mouseover/i.test(h.pagerEvent) ? j.hover(l,
            function() {}) : j.bind(h.pagerEvent, l),
            /^click/.test(h.pagerEvent) || h.allowPagerClickBubble || j.bind("click.cycle",
            function() {
                return ! 1
            });
            var n = h.$cont[0],
    ...
    a.fn.cycle.custom = function(b, c, d, e, f, g) {
        ...
        o = d.animOutDelay;
        i.css(d.cssBefore),
        g && (j = k = "number" == typeof g ? g: 1, l = m = null);
        var p = function() {
            i.delay(n).animate(d.animIn, j, l,
            function() {
                e()
            })
        };
        h.delay(o).animate(d.animOut, k, m,
        function() {
            h.css(d.cssAfter),
            d.sync || p()
        }),
...
function(a) {
    ...
    a.fn.cycle.transitions.shuffle = function(b, c, d) {
        ...
        d.fxFn = function(b, c, d, e, f) {
            ...
            function() {
                ...
                if (f) for (var j = 0,
                k = d.els.length; k > j; j++) a(d.els[j]).css("z-index", k - j + h);
                else {
    ...
    a.fn.cycle.transitions.cover = function(b, c, d) {
        ...
        d.before.push(function(b, c, d) {
            a.fn.cycle.commonReset(b, c, d),
            d.cssAfter.display = "",
            "right" == e ? d.cssBefore.left = -f: "up" == e ? d.cssBefore.top = g: "down" == e ? d.cssBefore.top = -g: d.cssBefore.left = f
        }),
        d.animIn.left = 0,
        d.animIn.top = 0,
        d.cssBefore.top = 0,
    ...
    a.fn.cycle.transitions.uncover = function(b, c, d) {
        ...
        d.before.push(function(b, c, d) {
            a.fn.cycle.commonReset(b, c, d, !0, !0, !0),
            "right" == e ? d.animOut.left = f: "up" == e ? d.animOut.top = -g: "down" == e ? d.animOut.top = g: d.animOut.left = -f
        }),
        d.animIn.left = 0,
        d.animIn.top = 0,
        d.cssBefore.top = 0,
    ...
    a.fn.cycle.transitions.toss = function(b, c, d) {
        ...
        d.before.push(function(b, c, d) {
            a.fn.cycle.commonReset(b, c, d, !0, !0, !0),
            d.animOut.left || d.animOut.top ? d.animOut.opacity = 0 : a.extend(d.animOut, {
                left: 2 * e,
                top: -f / 2,
                opacity: 0
            })
...
function(a) {
    var b = function(a, b) {
        ...
        i = function() {
            ...
            e.save();
            for (var d = 24; d > 0; --d) d % 6 === 0 ? (c = b.scaleLength, a = 0) : (c = .6 * b.scaleLength, a = b.scaleLength - c),
    ...
    b.Slideshow.prototype = {
        _init: function(a) {
            ...
            b.when(this._preloadImages()).done(function() {
                ...
                c.options.autoplay && c._startSlideshow(),
                c._initEvents()
            })
        },
        _preloadImages: function() {
            ...
            return b.Deferred(function(d) {
                a.$images.each(function(e) {
                    b("<img/>").load(function() {++c === a.itemsCount && d.resolve()
        ...
        _startSlideshow: function() {
            ...
            this.slideshow = setTimeout(function() {
                var b;
                b = a.current === a.itemsCount - 1 ? 0 : a.current + 1,
                a._slideTo(b),
        ...
        _slideTo: function(a) {
            ...
            "sides" === this.options.animation && (f.left = a > this.current ? -1 * this.elWidth: this.elWidth, g.left = 0),
            d.find("div.ei-title > h2").css("margin-right", "50px").stop().delay(this.options.speed * this.options.titlesFactor).animate({
                marginRight: "0px",
                opacity: 1
            },
            ...
            b.when(c.css("z-index", 1).find("div.ei-title > *").stop().fadeOut(this.options.speed / 2,
            function() {
        ...
        _initEvents: function() {
            var c = this;
            b(a).on("smartresize.eislideshow",
            function(a) {
                c._setImagesSize(),
                c.$sliderElem.css("left", c.$thumbs.eq(c.current).position().left)
            }),
            this.$thumbs.on("click.eislideshow",
            function(a) {
    ...
    u = function(a, b) {
        ...
        this.updateScrollBar = function(a) {
            ...
            s.railh && s.railh.css({
                ...
                c.top += l(s.win, "border-top-width", !0); (s.win.outerWidth() - s.win.innerWidth()) / 2;
        ...
        this.init = function() {
            ...
            function b(a) {
                ...
                if (s.iframexd) return "console" in window,
                !0;
                ...
                "contentWindow" in this ? s.bind(this.contentWindow, "scroll", s.onscroll) : s.bind(b, "scroll", s.onscroll),
                s.opt.enablemousewheel && s.bind(b, "mousewheel", s.onmousewheel),
                s.opt.enablekeyboard && s.bind(b, w.isopera ? "keypress": "keydown", s.onkeypress),
                (w.cantouch || s.opt.touchbehavior) && (s.bind(b, "mousedown", s.ontouchstart), s.bind(b, "mousemove",
                function(a) {
                    s.ontouchmove(a, !0)
                }), s.opt.grabcursorenabled && w.cursorgrabvalue && s.css(j(b.body), {
                    cursor: w.cursorgrabvalue
                })),
                s.bind(b, "mouseup", s.ontouchend),
                s.zoom && (s.opt.dblclickzoom && s.bind(b, "dblclick", s.doZoom), s.ongesturezoom && s.bind(b, "gestureend", s.ongesturezoom))
            }
            ...
            if (w.hasmstouch && s.css(s.ispage ? j("html") : s.win, {
                ...
                s.railh && (t.css({
                    ...
                    if (s.ishwscroll) {
                        ...
                        s.viewport && (s.body = s.viewport, 0 == /relative|absolute/.test(s.viewport.css("position")) && s.css(s.viewport, {
                            position: "relative"
                        })),
                        l.css({
                            position: x
                ...
                if (s.opt.autohidemode === !1 ? (s.autohidedom = !1, s.rail.css({
                    ...
                    s.onmangotouch = function(a) {
                        ...
                        if (0 != f) {
                            ...
                            h = 0 > e ? -1 : 1,
                            i = +new Date;
                            if (s.mangotouch.lazy && clearTimeout(s.mangotouch.lazy), i - s.mangotouch.tm > 80 || s.mangotouch.dry != g || s.mangotouch.drx != h) s.scrollmom.stop(),
                            s.scrollmom.reset(c, b),
                            s.mangotouch.sy = b,
                            s.mangotouch.ly = b,
                            s.mangotouch.sx = c,
                            s.mangotouch.lx = c,
                            ...
                            s.mangotouch.tm = i;
                                ...
                                s.scrollmom.stop(),
                                s.scrollmom.update(s.mangotouch.sx - e, s.mangotouch.sy - d);
                                i - s.mangotouch.tm;
                                s.mangotouch.tm = i;
                                var j = Math.max(Math.abs(s.mangotouch.ly - b), Math.abs(s.mangotouch.lx - c));
                                s.mangotouch.ly = b,
                                s.mangotouch.lx = c,
                                j > 2 && (s.mangotouch.lazy = setTimeout(function() {
                                    s.mangotouch.lazy = !1,
                                    s.mangotouch.dry = 0,
                                    s.mangotouch.drx = 0,
                                    s.mangotouch.tm = 0,
                        ...
                        s.ontouchstart = function(a) {
                            ...
                            if (!s.locked) {
                                ...
                                s.ispage || !s.opt.directionlockdeadzone) s.rail.drag.dl = "f";
                                    ...
                                    i = Math.max(0, g.w - f.w); ! s.rail.scrollable && s.railh.scrollable ? s.rail.drag.ck = h > 0 ? "v": !1 : s.rail.scrollable && !s.railh.scrollable ? s.rail.drag.ck = i > 0 ? "h": !1 : s.rail.drag.ck = !1,
                                ...
                                if (s.hasmoving = !1, s.lastmouseup = !1, s.scrollmom.reset(a.clientX, a.clientY), !w.cantouch && !this.istouchcapable && !w.hasmstouch) {
                                    ...
                                    s.opt.touchbehavior ? s.cancelEvent(a) : s.stopPropagation(a);
        ...
        this.bind = function(a, b, c, d) {
            ...
            if (void 0 == e && (e = a), "mousewheel" == b) if ("onwheel" in s.win) s._bind(e, "wheel", c, d || !1);
            else {
        ...
        this.doScrollPos = function(a, b, c) {
            ...
            s.scrollrunning && a == s.newscrollx && b == s.newscrolly ? !1 : (s.newscrolly = b, s.newscrollx = a, s.newscrollspeed = c || !1, s.timer ? !1 : void(s.timer = setTimeout(function() {
        ...
        this.doScrollPos = function(a, b, c) {
            ...
            if (c && 1 >= c && (j *= c), j > 0 ? s.bzscroll = s.bzscroll ? s.bzscroll.update(i, j) : new BezierClass(h, i, j, 0, 1, 0, 1) : s.bzscroll = !1, !s.timer) { (e == s.page.maxh && b >= s.page.maxh || f == s.page.maxw && a >= s.page.maxw) && s.checkContentSize();
                var k = 1;
        ...
        this.doScrollBy = function(a, b) {
            ...
            py = s.getScrollTop(!0),
            0 > c && py <= 0 ? s.noticeCursor() : c > s.page.maxh && py >= s.page.maxh ? (s.checkContentSize(), s.noticeCursor()) : void s.doScrollTop(c)
        },
        this.doScrollLeftBy = function(a, b) {
            ...
            0 > c && px <= 0 ? s.noticeCursor() : c > s.page.maxw && px >= s.page.maxw ? s.noticeCursor() : void s.doScrollLeft(c)
        },
...
function(a) {
    a.flexslider = function(b, c) {
        ...
        p = {
            ...
            controlNav: {
                ...
                setupPaging: function() {
                    ...
                    p.controlNav.set(),
                    p.controlNav.active(),
                    d.controlNavScaffold.delegate("a, img", i,
                    function(b) {
            ...
            directionNav: {
                setup: function() {
                    ...
                    d.controlsContainer ? (a(d.controlsContainer).append(b), d.directionNav = a("." + f + "direction-nav li a", d.controlsContainer)) : (d.append(b), d.directionNav = a("." + f + "direction-nav li a", d)),
                    p.directionNav.update(),
                    d.directionNav.bind(i,
                    function(b) {
                        b.preventDefault();
                        var c; ("" === j || j === b.type) && (c = a(this).hasClass(f + "next") ? d.getTarget("next") : d.getTarget("prev"), d.flexAnimate(c, d.vars.pauseOnAction)),
                        "" === j && (j = b.type),
                        p.setToClearWatchedEvent()
                    })
                },
            ...
            pausePlay: {
                setup: function() {
                    ...
                    d.controlsContainer ? (d.controlsContainer.append(b), d.pausePlay = a("." + f + "pauseplay a", d.controlsContainer)) : (d.append(b), d.pausePlay = a("." + f + "pauseplay a", d)),
                    p.pausePlay.update(d.vars.slideshow ? f + "pause": f + "play"),
                    d.pausePlay.bind(i,
                    function(b) {
                        b.preventDefault(),
                        ("" === j || j === b.type) && (a(this).hasClass(f + "pause") ? (d.manualPause = !0, d.manualPlay = !1, d.pause()) : (d.manualPause = !1, d.manualPlay = !0, d.play())),
                        "" === j && (j = b.type),
                        p.setToClearWatchedEvent()
                    })
                },
            ...
            touch: function() {
                ...
                function c(a) {
                    ...
                    v = a.touches[0].pageY,
                    r = k ? j - v: j - u,
                    t = k ? Math.abs(r) < Math.abs(u - o) : Math.abs(r) < Math.abs(v - o);
                    var b = 500; (!t || Number(new Date) - s > b) && (a.preventDefault(), !n && d.transitions && (d.vars.animationLoop || (r /= 0 === d.currentSlide && 0 > r || d.currentSlide === d.last && r > 0 ? Math.abs(r) / q + 2 : 1), d.setProps(p + r, "setTouch")))
                }
                function e(a) {
                    ...
                    b.removeEventListener("touchend", e, !1),
                    j = null,
                    o = null,
                    r = null,
                    p = null
        ...
        d.setup = function(b) {
            ...
            d.vars.smoothHeight && p.smoothHeight();
                ...
                "init" === b && (d.viewport = a('<div class="' + f + 'viewport"></div>').css({
                    overflow: "hidden",
                    position: "relative"
                }).appendTo(d).append(d.container), d.cloneCount = 0, d.cloneOffset = 0, l && (e = a.makeArray(d.slides).reverse(), d.slides = a(e), d.container.empty().append(d.slides))),
        ...
        d.doMath = function() {
            ...
            m ? (d.itemT = d.vars.itemWidth + b, d.minW = c ? c * d.itemT: d.w, d.maxW = e ? e * d.itemT - b: d.w, d.itemW = d.minW > d.w ? (d.w - b * (c - 1)) / c: d.maxW < d.w ? (d.w - b * (e - 1)) / e: d.vars.itemWidth > d.w ? d.w: d.vars.itemWidth, d.visible = Math.floor(d.w / (d.itemW + b)), d.move = d.vars.move > 0 && d.vars.move < d.visible ? d.vars.move: d.visible, d.pagingCount = Math.ceil((d.count - d.visible) / d.move + 1), d.last = d.pagingCount - 1, d.limit = 1 === d.pagingCount ? 0 : d.vars.itemWidth > d.w ? d.itemW * (d.count - 1) + b * (d.count - 1) : (d.itemW + b) * d.count - d.w - b) : (d.itemW = d.w, d.pagingCount = d.count, d.last = d.count - 1),
        ...
        d.destroy = function() {
            ...
            d.vars.controlNav && d.controlNav.closest(b + "control-nav").remove(),
            d.vars.directionNav && d.directionNav.closest(b + "direction-nav").remove(),
            d.vars.pausePlay && d.pausePlay.closest(b + "pauseplay").remove(),
            d.find(".clone").remove(),
            d.unbind(d.vars.eventNamespace),
            "fade" != d.vars.animation && d.container.unwrap(),
            d.container.removeAttr("style"),
            d.container.unbind(d.vars.eventNamespace),
            d.slides.removeAttr("style"),
            d.slides.filter(b + "active-slide").removeClass(d.vars.namespace + "active-slide"),
            d.slides.unbind(d.vars.eventNamespace),
            a(document).unbind(d.vars.eventNamespace + "-" + d.id),
            a(window).unbind(d.vars.eventNamespace + "-" + d.id),
            d.stop(),
            d.removeData("flexslider")
        },
        p.init()
    },
...
function(a, b, c, d) {
    ...
    a.extend(e.prototype, {
        init: function() {
            ...
            f = a(c).width() > 640 ? !0 : !1,
            g = this;
            this.settings.scrollwheel || (e.draggable = f),
            this.settings.address_pin || (this.settings.addresses = [this.settings.addresses[0]]),
            jQuery.each(this.settings.addresses,
            function(a) {
                0 == this.cache && (g.last_cache_index = a)
            }),
            this.settings.addresses[0].coordinates && (b = new google.maps.LatLng(this.settings.addresses[0].latitude, this.settings.addresses[0].longitude), e.center = b),
            this.map = new google.maps.Map(this.element, e),
            this.settings.overlay_color && "custom" == this.settings.map_style && (d = [{
                stylers: [{
        ...
        geocode_address: function(a, b) {
            ...
            function(d, e) {
                ...
                if (e == google.maps.GeocoderStatus.OK ? (a.coordinates === !0 ? (j = c, f = jQuery.trim(a.latitude), g = jQuery.trim(a.longitude)) : (j = d[0].geometry.location, f = j.lat(), g = j.lng()), h.settings.addresses[b].latitude = f, h.settings.addresses[b].longitude = g, a.coordinates === !0 && "" === a.infobox_content && (a.geocoded_address = d[0].formatted_address), 1 != h.next_address || a.coordinates || h.map.setCenter(j), h.settings.address_pin && h.create_marker(a, f, g), 0 == h.next_address && h.map.setCenter(j)) : e == google.maps.GeocoderStatus.OVER_QUERY_LIMIT && (h.next_address--, h.settings.delay++), 0 == i && 0 == h.query_sent && h.last_cache_index == b) {
                    ...
                    jQuery.post(js_local_vars.admin_ajax, k),
                    h.query_sent = !0
                }
        ...
        create_marker: function(a, b, c, d) {
            ...
            a.infobox_content ? e = a.infobox_content: (e = a.address, a.coordinates === !0 && a.geocoded_address && (e = a.geocoded_address)),
            this.settings.animations && (g.animation = google.maps.Animation.DROP),
            "custom" == this.settings.map_style && "theme" == this.settings.marker_icon ? g.icon = new google.maps.MarkerImage(a.marker, null, null, null, new google.maps.Size(37, 55)) : "custom" == this.settings.map_style && a.marker && (g.icon = a.marker),
            f = new google.maps.Marker(g),
            this.markers.push(f),
            this.create_infowindow(e, f),
            this.next_address >= this.settings.addresses.length && this.map.fitBounds(this.bounds)
        },
        create_infowindow: function(a, b) {
            ...
            e.className = "fusion-info-box", e.style.cssText = "background-color:" + this.settings.infobox_background_color + ";color:" + this.settings.infobox_text_color + ";", e.innerHTML = a, d = new InfoBox(f), d.open(this.map, b), this.settings.show_address || d.close(this.map, b), google.maps.event.addListener(b, "click",
            function() {
                var a = d.getMap();
                ...
                disableAutoPan: !0,
                content: a
            }), this.settings.show_address && (d.show = !0, d.open(this.map, b)), google.maps.event.addListener(b, "click",
            function() {
                var a = d.getMap();
                null === a || "undefined" == typeof a ? d.open(g.map, this) : d.close(g.map, this)
            }))
        ...
        next_geocode_request: function() {
            ...
            a.next_address < a.settings.addresses.length && setTimeout(function() {
                a.geocode_address(a.settings.addresses[a.next_address], a.next_address),
                a.next_address++
            },
            a.settings.delay)
        }
...
function(a) {
    a.fn.hoverFlow = function(b, c, d, e, f) {
        ...
        return g.complete = function() {
            a(this).dequeue(),
            a.isFunction(h) && h.call(this)
        },
        this.each(function() {
            var d = a(this);
            "mouseover" == b || "mouseenter" == b ? d.data("jQuery.hoverFlow", !0) : d.removeData("jQuery.hoverFlow"),
            d.queue(function() {
...
function(a) {
    a.fn.hoverIntent = function(b, c, d) {
        ...
        k = function(b, c) {
            ...
            Math.abs(h - f) + Math.abs(i - g) < e.sensitivity ? (a(c).off("mousemove.hoverIntent", j), c.hoverIntent_s = 1, e.over.apply(c, [b])) : (h = f, i = g, c.hoverIntent_t = setTimeout(function() {
                k(b, c)
            },
            e.interval), void 0)
        },
        ...
        m = function(b) {
            ...
            "mouseenter" == b.type ? (h = c.pageX, i = c.pageY, a(d).on("mousemove.hoverIntent", j), 1 != d.hoverIntent_s && (d.hoverIntent_t = setTimeout(function() {
                k(c, d)
            },
...
function(a) {
    ...
    a.infinitescroll.prototype = {
        _binding: function(a) {
            ...
            d.behavior && this["_binding_" + d.behavior] !== b ? void this["_binding_" + d.behavior].call(this) : "bind" !== a && "unbind" !== a ? (this._debug("Binding value  " + a + " not valid"), !1) : ("unbind" === a ? this.options.binder.unbind("smartscroll.infscr." + c.options.infid) : this.options.binder[a]("smartscroll.infscr." + c.options.infid,
            function() {
                c.scroll()
        ...
        _create: function(c, d) {
            ...
            if (!h) return this._debug("Navigation selector not found"),
            !1;
            ...
            var i = this;
            return e.loading.start = e.loading.start ||
            function() {
                a(e.navSelector).hide(),
                e.loading.msg.insertAfter(e.loading.selector).show(e.loading.speed, a.proxy(function() {
                    this.beginAjax(e)
                },
                i))
            },
        ...
        _showdonemsg: function() {
            ...
            function() {
                ...
                a(".fusion-load-more-button").fadeOut(c.loading.speed)
        ...
        beginAjax: function(c) {
            var d, e, f, g, h = this,
            i = c.path;
            if (c.state.currPage++, c.maxPage !== b && c.state.currPage > c.maxPage) return c.state.isBeyondMaxPage = !0,
            void this.destroy();
            ...
            case "json":
                ...
                a.ajax({
                    ...
                    success: function(a, f, i) {
                        if (g = "undefined" != typeof i.isResolved ? i.isResolved() : "success" === f || "notmodified" === f, c.appendCallback) if (c.template !== b) {
                            var j = c.template(a);
                            d.append(j),
                            g ? h._loadcallback(d, j) : h._error("end")
                        } else h._debug("template must be defined."),
                        h._error("end");
...
function(a) {
    a.fn.UItoTop = function(b) {
        ...
        a("body").append('<div class="to-top-container"><a href="#" id="' + d.containerID + '"><span class="screen-reader-text">' + toTopscreenReaderText.label + "</span>" + d.text + "</a></div>"),
        a(e).hide().on("click.UItoTop",
        function() {
            return a("html, body").animate({
                scrollTop: 0
            },
            d.scrollSpeed, d.easingType),
            a("#" + d.containerHoverID, this).stop().animate({
                opacity: 0
            },
    ...
    function(c, d) {
        ...
        m = {
            ...
            _filter: function(a, b, d) {
                var e, f;
                return (e = k[c(a).data(j)]) ? (f = [], c.each(e.waypoints[b],
                function(a, b) {
...
function(a, b, c) {
    ...
    function e() {
        ...
        for (var i in u) if (u.hasOwnProperty(i)) {
            ...
            h = g.split("."),
            1 === h.length ? w[h[0]] = e: (!w[h[0]] || w[h[0]] instanceof Boolean || (w[h[0]] = new Boolean(w[h[0]])), w[h[0]][h[1]] = e),
            t.push((e ? "": "no-") + h.join("-"))
        }
    }
    function f(a) {
    ...
    function g(a, b) {
        if ("object" == typeof a) for (var c in a) C(a, c) && g(c, a[c]);
        else {
            a = a.toLowerCase();
            var d = a.split("."),
            e = w[d[0]];
            ...
            1 == d.length ? w[d[0]] = b: (!w[d[0]] || w[d[0]] instanceof Boolean || (w[d[0]] = new Boolean(w[d[0]])), w[d[0]][d[1]] = b),
            f([(b && 0 != b ? "": "no-") + d.join("-")]),
            w._trigger(a, b)
        }
        return w
    ...
    function k() {
        var a = b.body;
        return a || (a = h(z ? "svg": "body"), a.fake = !0),
        a
    }
    function l(a, c, d, e) {
        ...
        m = h("div"),
        n = k();
        if (parseInt(d, 10)) for (; d--;) i = h("div"),
        i.id = e ? e[d] : l + (d + 1),
        m.appendChild(i);
        return f = h("style"),
        f.type = "text/css",
        ...
        m.id = l,
        n.fake && (n.style.background = "", n.style.overflow = "hidden", j = y.style.overflow, y.style.overflow = "hidden", y.appendChild(n)),
        g = c(m, a),
        n.fake ? (n.parentNode.removeChild(n), y.style.overflow = j, y.offsetHeight) : m.parentNode.removeChild(m),
        !!g
    }
    function m(a, b) {
        return function() {
    ...
    function n(a, b, c) {
        var e;
        for (var f in a) if (a[f] in b) return c === !1 ? a[f] : (e = b[a[f]], d(e, "function") ? m(e, c || b) : e);
        return ! 1
    }
    function o(a) {
        return a.replace(/([A-Z])/g,
    ...
    function p(b, d) {
        ...
        if ("CSS" in a && "supports" in a.CSS) {
            for (; e--;) if (a.CSS.supports(o(b[e]), d)) return ! 0;
            return ! 1
        }
        if ("CSSSupportsRule" in a) {
            for (var f = []; e--;) f.push("(" + o(b[e]) + ":" + d + ")");
            return f = f.join(" or "),
            l("@supports (" + f + ") { #modernizr { position: absolute; } }",
            function(a) {
    ...
    function q(a, b, e, f) {
        ...
        for (var l, m, n, o, q, r = ["modernizr", "tspan"]; ! S.style;) l = !0,
        S.modElem = h(r.shift()),
        S.style = S.modElem.style;
        for (n = a.length, m = 0; n > m; m++) if (o = a[m], q = S.style[o], j(o, "-") && (o = i(o)), S.style[o] !== c) {
            if (f || d(e, "undefined")) return g(),
            "pfx" == b ? o: !0;
            try {
                S.style[o] = e
            } catch(s) {}
            if (S.style[o] != q) return g(),
            "pfx" == b ? o: !0
        }
        return g(),
        !1
    ...
    w.prototype = v,
    w = new w,
    w.addTest("applicationcache", "applicationCache" in a),
    ...
    w.addTest("websockets", "WebSocket" in a && 2 === a.WebSocket.CLOSING),
    w.addTest("localstorage",
    function() {
        var a = "modernizr";
        try {
    ...
    w.addTest("websqldatabase", "openDatabase" in a),
    w.addTest("webworkers", "Worker" in a);
    ...
    function() {
        ...
        C = d(a, "undefined") || d(a.call, "undefined") ?
        function(a, b) {
    ...
    v.on = function(a, b) {
        this._l[a] || (this._l[a] = []),
        this._l[a].push(b),
        w.hasOwnProperty(a) && setTimeout(function() {
            w._trigger(a, w[a])
        },
        0)
    },
    ...
    function() {
        var a = h("audio"),
        b = !1;
        try { (b = !!a.canPlayType) && (b = new Boolean(b), b.ogg = a.canPlayType('audio/ogg; codecs="vorbis"').replace(/^no$/, ""), b.mp3 = a.canPlayType('audio/mpeg; codecs="mp3"').replace(/^no$/, ""), b.opus = a.canPlayType('audio/ogg; codecs="opus"') || a.canPlayType('audio/webm; codecs="opus"').replace(/^no$/, ""), b.wav = a.canPlayType('audio/wav; codecs="1"').replace(/^no$/, ""), b.m4a = (a.canPlayType("audio/x-m4a;") || a.canPlayType("audio/aac;")).replace(/^no$/, ""))
        } catch(c) {}
        return b
    }),
    w.addTest("canvas",
    ...
    function() {
        for (var a, b = "background-image:",
        c = "gradient(linear,left top,right bottom,from(#9f9),to(white));",
        d = "",
        e = 0,
        f = x.length - 1; f > e; e++) a = 0 === e ? "to ": "",
        d += b + x[e] + "linear-gradient(" + a + "left top, #9f9, white);";
        w._config.usePrefixes && (d += b + "-webkit-" + c);
        var g = h("a"),
        i = g.style;
        return i.cssText = d,
        ("" + i.backgroundImage).indexOf("gradient") > -1
    }),
    ...
    function() {
        var a = h("a").style;
        return a.cssText = x.join("opacity:.55;"),
        /^0.55$/.test(a.opacity)
    }),
    w.addTest("rgba",
    function() {
    ...
    w.input = function(b) {
        for (var c = 0,
        d = b.length; d > c; c++) G[b[c]] = !!(b[c] in E);
        return G.list && (G.list = !(!h("datalist") || !a.HTMLDataListElement)),
        G
    } (F);
    var H = "search tel url email datetime date month week time datetime-local number range color".split(" "),
    I = {};
    w.inputtypes = function(a) {
        for (var d, e, f, g = a.length,
        h = "1)",
        i = 0; g > i; i++) E.setAttribute("type", d = a[i]),
        f = "text" !== E.type && "style" in E,
        f && (E.value = h, E.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(d) && E.style.WebkitAppearance !== c ? (y.appendChild(E), e = b.defaultView, f = e.getComputedStyle && "textfield" !== e.getComputedStyle(E, null).WebkitAppearance && 0 !== E.offsetHeight, y.removeChild(E)) : /^(search|tel)$/.test(d) || (f = /^(url|email)$/.test(d) ? E.checkValidity && E.checkValidity() === !1 : E.value != h)),
        I[a[i]] = !!f;
        return I
    } (H),
    w.addTest("hsla",
    function() {
        ...
        j(a.backgroundColor, "rgba") || j(a.backgroundColor, "hsla")
    });
    var J = "CSS" in a && "supports" in a.CSS,
    K = "supportsCSS" in a;
    w.addTest("supports", J || K);
    var L = {}.toString;
    w.addTest("svgclippaths",
    function() {
    ...
    var M = function() {
        ...
        function(a) {
            ...
            var c = !1;
            return l("@media " + b + " { #modernizr { position: absolute; } }",
            function(b) {
    ...
    O ? w.addTest("fontface", !1) : N('@font-face {font-family:"font";src:url("https://")}',
    function(a, c) {
    ...
    N('#modernizr{font:0/0 a}#modernizr:after{content:":)";visibility:hidden;font:7px/1 a}',
    function(a) {
    ...
    w.addTest("textshadow", T("textShadow", "1px 1px")),
    v.testAllProps = r;
    ...
    w.addTest("indexeddb", !!U),
    U && w.addTest("indexeddb.deletedatabase", "deleteDatabase" in U),
    v.testAllProps = s,
    w.addTest("cssanimations", s("animationName", "a", !0)),
    w.addTest("backgroundsize", s("backgroundSize", "100%", !0)),
    w.addTest("borderimage", s("borderImage", "url() 1", !0)),
    w.addTest("borderradius", s("borderRadius", "0px", !0)),
    w.addTest("boxshadow", s("boxShadow", "1px 1px", !0)),
    w.addTest("flexbox", s("flexBasis", "1px", !0)),
    w.addTest("cssreflections", s("boxReflect", "above", !0)),
    ...
    function() {
        ...
        if (a && (!b || "webkitPerspective" in y.style)) {
            ...
            w.supports ? c = "@supports (perspective: 1px)": (c = "@media (transform-3d)", b && (c += ",(-webkit-transform-3d)")),
...
function(a, b, c) {
    ...
    g = ["ms", "moz", "webkit", "o"], h = 0, i = g.length; i > h && !b.requestAnimationFrame; ++h) b.requestAnimationFrame = b[g[h] + "RequestAnimationFrame"],
...
function($, window, undefined) {
    ...
    function findImageInElement(a) {
        ...
        return b.each(function() {
            ...
            if ("none" != $(b).css("background-image") ? a = $(b).css("background-image") : "undefined" != typeof $(b).attr("src") && "img" == b.nodeName.toLowerCase() && (a = $(b).attr("src")), -1 == a.indexOf("gradient")) {
                ...
                a = a.replace(/\"\)/g, ""),
                a = a.replace(/\)/g, "");
                for (var d = a.split(","), e = 0; e < d.length; e++) if (d[e].length > 0 && -1 == $.inArray(d[e], c)) {
                    var f = "";
                    browser.msie && browser.version < 9 && (f = "?" + floor(3e3 * random())),
                    c.push(d[e] + f)
                }
            }
        }),
    ...
    function absolutizeURI(a, b) {
        function c(a) {
            var b = [];
            return a.replace(/^(\.\.?(\/|$))+/, "").replace(/\/(\.(\/|$))+/g, "/").replace(/\/\.\.$/, "/../").replace(/\/?[^\/]*/g,
            function(a) {
                "/.." === a ? b.pop() : b.push(a)
            }),
        ...
        return b = parseURI(b || ""),
        a = parseURI(a || ""),
        b && a ? (b.protocol || a.protocol) + (b.protocol || b.authority ? b.authority: a.authority) + c(b.protocol || b.authority || "/" === b.pathname.charAt(0) ? b.pathname: b.pathname ? (a.authority && !a.pathname ? "/": "") + a.pathname.slice(0, a.pathname.lastIndexOf("/") + 1) + b.pathname: a.pathname) + (b.protocol || b.authority || b.pathname ? b.search: b.search || a.search) + b.hash: null
    }
    function version_compare(a, b, c) {
        ...
        for (a = h(a), b = h(b), e = max(a.length, b.length), d = 0; e > d; d++) if (a[d] != b[d]) {
    ...
    function _QTAddAttribute(a, b, c) {
        var d;
        return d = gTagAttrs[a + b],
        null == d && (d = gTagAttrs[b]),
        null != d ? (0 == b.indexOf(a) && null == c && (c = b.substring(a.length)), null == c && (c = b), c + '="' + d + '" ') : ""
    }
    ...
    function _QTGenerate(a, b, c) {
        ...
        for (var d, e = 4; e < c.length; e += 2) d = c[e].toLowerCase(),
        a = c[e + 1],
        "name" == d || "id" == d ? gTagAttrs.name = a: gTagAttrs[d] = a;
        ...
        for (d in gTagAttrs) a = gTagAttrs[d],
        null != a && (e += _QTAddEmbedAttr(d), c += _QTAddObjectParam(d, b));
        return c + e + "> </embed>\n</object>"
    }
    ...
    iLightBox = function(a, b, c, d) {
        ...
        e.vars.hideableElements = e.vars.nextButton.add(e.vars.prevButton), e.normalizeItems(), e.availPlugins(), e.options.startFrom = e.options.startFrom > 0 && e.options.startFrom >= e.vars.total ? e.vars.total - 1 : e.options.startFrom, e.options.startFrom = e.options.randomStart ? floor(random() * e.vars.total) : e.options.startFrom, e.vars.start = e.options.startFrom, d ? e.instantCall() : e.patchItemsEvents(), e.options.linkId && (e.hashChangeHandler(), $win.iLightBoxHashChange(function() {
            ...
            g = "itap";
            e.options.caption.show = e.options.caption.show.replace(f, g),
            e.options.caption.hide = e.options.caption.hide.replace(f, g),
            e.options.social.show = e.options.social.show.replace(f, g),
            e.options.social.hide = e.options.social.hide.replace(f, g)
        }
    ...
    iLightBox.prototype = {
        showLoader: function() {
            ...
            "horizontal" == a.options.path.toLowerCase() ? a.vars.loader.stop().animate({
                top: "-30px"
            },
        ...
        hideLoader: function() {
            var a = this;
            a.vars.loadRequests -= 1,
            a.vars.loadRequests = a.vars.loadRequests < 0 ? 0 : a.vars.loadRequests,
            "horizontal" == a.options.path.toLowerCase() ? a.vars.loadRequests <= 0 && a.vars.loader.stop().animate({
                top: "-192px"
            },
        ...
        normalizeItems: function() {
            ...
            function(c, d) {
                ...
                f.thumbnail = f.thumbnail || ("image" == i ? e: null),
                ...
                f.social = "undefined" != typeof f.social ? f.social: a.options.social.buttons && $.extend({},
                {},
                a.options.social.buttons),
                "video" == i && (f.html5video = "undefined" != typeof f.html5video ? f.html5video: {},
        ...
        instantCall: function() {
            ...
            b = a.vars.start;
            a.vars.current = b,
            a.vars.next = a.items[b + 1] ? b + 1 : null,
            a.vars.prev = a.items[b - 1] ? b - 1 : null,
            a.addContents(),
            a.patchEvents()
        },
        addContents: function() {
            ...
            c.controls.toolbar && (b.toolbar.addClass(c.skin).append(b.closeButton), c.controls.fullscreen && b.toolbar.append(b.fullScreenButton), c.controls.slideshow && b.toolbar.append(b.innerPlayButton), b.total > 1 && b.toolbar.append(b.innerPrevButton).append(b.innerNextButton)),
            ...
            c.controls.thumbnail && b.total > 1 && (b.BODY.append(b.thumbnails), b.thumbnails.addClass(c.skin).addClass("ilightbox-" + e), $("div.ilightbox-thumbnails-grid", b.thumbnails).empty(), b.thumbs = !0);
            ...
            b.loader.addClass(c.skin).css(h),
        ...
        loadContent: function(a, b, c) {
            ...
            if (d.removeAttr("style class").addClass("ilightbox-holder" + (supportTouch ? " supportTouch": "")).addClass(a.options.skin), $("div.ilightbox-inner-toolbar", d).remove(), a.title || f.options.innerToolbar) {
                ...
                f.options.innerToolbar && g.append(f.vars.total > 1 ? f.vars.toolbar.clone() : f.vars.toolbar),
                d.prepend(g)
            }
        ...
        loadSwitcher: function(a, b, c, d) {
            ...
            switch (a.type) {
            case "image":
                "function" == typeof g.callback.onBeforeLoad && g.callback.onBeforeLoad.call(e, e.ui, c),
                "function" == typeof a.options.onBeforeLoad && a.options.onBeforeLoad.call(e, h),
                e.loadImage(a.URL,
                function(f) {
                    "function" == typeof g.callback.onAfterLoad && g.callback.onAfterLoad.call(e, e.ui, c),
                    ...
                    $("div.ilightbox-container", b).empty().append(f ? '<img src="' + a.URL + '" class="ilightbox-image" />': '<span class="ilightbox-alert">' + g.errors.loadImage + "</span>"),
                    "function" == typeof g.callback.onRender && g.callback.onRender.call(e, e.ui, c),
            ...
            case "video":
                ...
                break;
            case "iframe":
                for (var i = a.URL.substring(a.URL.indexOf("?") + 1).split("&"), j = {},
                k = 0; k < i.length; ++k) {
                    var l = i[k].split("=");
            ...
            case "ajax":
                ...
                $.ajax({
                    ...
                    success: function(f, i, j) {
                        ...
                        l.empty().append($('<div class="ilightbox-wrapper"></div>').css(o).html(k)),
                        b.show().data({
                        ...
                        g.ajaxSetup.success(f, i, j),
                        "function" == typeof p.success && p.success(f, i, j)
                    },
                    error: function(i, j, k) {
                        ...
                        f,
                        e.hideLoader(),
                        $("div.ilightbox-container", b).empty().append('<span class="ilightbox-alert">' + g.errors.loadContents + "</span>"),
                        e.configureHolder(a, d, b),
                        g.ajaxSetup.error(i, j, k),
                        "function" == typeof p.error && p.error(i, j, k)
                    }
                });
                break;
            case "html":
                ...
                e.addContent(b, a),
                m.appendTo(document.documentElement).hide(),
                "function" == typeof g.callback.onRender && g.callback.onRender.call(e, e.ui, c),
                "function" == typeof a.options.onRender && a.options.onRender.call(e, h);
        ...
        configureHolder: function(a, b, c) {
            ...
            d.items[g].options.width = d.items[g].options.width || 0,
            d.items[g].options.height = d.items[g].options.height || 0,
            "current" == b ? f.show.effect ? c.css(transform, gpuAcceleration).fadeIn(a.speed,
            function() {
                ...
                h && (d.setSocial(h, a.URL, c), f.social.start && $("div.ilightbox-social", c).fadeIn(f.effects.fadeSpeed)),
                d.generateThumbnails(),
                "function" == typeof f.callback.onShow && f.callback.onShow.call(d, d.ui, g),
                "function" == typeof a.options.onShow && a.options.onShow.call(d, i)
            }) : (c.show(), d.generateThumbnails(), "function" == typeof f.callback.onShow && f.callback.onShow.call(d, d.ui, g), "function" == typeof a.options.onShow && a.options.onShow.call(d, i)) : f.show.effect ? c.fadeTo(a.speed, h,
            function() {
                ...
                opacity: h
            }).show(), "next" == b ? e.nextLock = !1 : e.prevLock = !1, d.generateThumbnails(), "function" == typeof f.callback.onShow && f.callback.onShow.call(d, d.ui, g), "function" == typeof a.options.onShow && a.options.onShow.call(d, i)),
            setTimeout(function() {
                d.repositionPhoto()
            },
            0)
        ...
        generateBoxes: function() {
            ...
            b = a.vars,
            c = a.options;
            c.infinite && b.total >= 3 ? (b.current == b.total - 1 && (b.next = 0), 0 == b.current && (b.prev = b.total - 1)) : c.infinite = !1,
            a.loadContent(a.items[b.current], "current", c.show.speed),
            a.items[b.next] && a.loadContent(a.items[b.next], "next", c.show.speed),
            a.items[b.prev] && a.loadContent(a.items[b.prev], "prev", c.show.speed)
        },
        generateThumbnails: function() {
            ...
            if (b.thumbs && !a.vars.dontGenerateThumbs) {
                ...
                function(i, j) {
                    ...
                    "video" != j.type && "flash" != j.type || "undefined" != typeof j.options.icon ? j.options.icon && (o.addClass("ilightbox-thumbnail-" + j.options.icon), n.append(o)) : (o.addClass("ilightbox-thumbnail-video"), n.append(o)),
                    m && a.loadImage(m,
                    function(b) {
                        h++,
                        b ? n.data({
        ...
        positionThumbnails: function(a, b, c) {
            ...
            a || (a = e.thumbnails),
            b || (b = $("div.ilightbox-thumbnails-container", a)),
            c || (c = $("div.ilightbox-thumbnails-grid", b));
            ...
            i.each(function(a) {
                ...
                height = "horizontal" == h ? f.thumbnails.maxHeight: 0,
                dims = d.getNewDimenstions(e, height, c.naturalWidth, c.naturalHeight, !0),
                b.css({
                    width: dims.width,
                    height: dims.height
                }),
            ...
            p.top = p.top - $doc.scrollTop(),
            p.left = p.left - $doc.scrollLeft(),
            q.top = q.top - p.top - $doc.scrollTop(),
            q.left = q.left - p.left - $doc.scrollLeft(),
            "horizontal" == h ? (o.top = 0, o.left = parseInt(j / 2 - q.left - n.outerWidth() / 2)) : (o.top = parseInt(k / 2 - q.top - n.outerHeight() / 2), o.left = 0),
            arguments.length < 3 ? c.stop().animate(o, f.effects.repositionSpeed, "easeOutCirc") : c.css(o)
        },
        loadImage: function(a, b) {
            $.isArray(a) || (a = [a]);
            var c = this,
            d = a.length;
            d > 0 ? (c.showLoader(), $.each(a,
            function(e, f) {
                var g = new Image;
                g.onload = function() {
                    d -= 1,
                    0 == d && (c.hideLoader(), b(g))
                },
        ...
        patchItemsEvents: function() {
            ...
            if (a.context && a.selector) {
                ...
                $(a.context).on(c, a.selector,
                function() {
                    var c = $(this),
                    d = e.index(c);
                    return b.current = d,
                    b.next = a.items[d + 1] ? d + 1 : null,
                    b.prev = a.items[d - 1] ? d - 1 : null,
                    a.addContents(),
                    a.patchEvents(),
                    !1
                }).on(d, a.selector,
        ...
        dispatchItemsEvents: function() {
            ...
            a.vars,
            a.options;
            a.context && a.selector ? $(a.context).off(".iL", a.selector) : $.each(a.itemsObject,
            function(a, b) {
                b.off(".iL")
            })
        },
        ...
        patchEvents: function() {
            ...
            function() {
                ...
                supportTouch && (clearTimeout(c.setTime), c.setTime = setTimeout(function() {
                    var a = getScrollXY().y;
            ...
            fullScreenApi.supportsFullScreen && $win.bind(g,
            function() {
                b.doFullscreen()
            });
            ...
            $doc.on(clickEvent, ".ilightbox-overlay",
            function() {
                d.overlay.blur && b.closeAction()
            }).on(clickEvent, ".ilightbox-next, .ilightbox-next-button",
            function() {
                b.moveTo("next")
            }).on(clickEvent, ".ilightbox-prev, .ilightbox-prev-button",
            function() {
                b.moveTo("prev")
            }).on(clickEvent, ".ilightbox-thumbnail",
            function() {
                var a = $(this),
                d = $(".ilightbox-thumbnail", c.thumbnails),
                e = d.index(a);
                e != c.current && b.goTo(e)
            }).on(l, ".ilightbox-holder:not(.ilightbox-next, .ilightbox-prev)",
            function(a) {
            ...
            }).on("mouseenter.iLightBox mouseleave.iLightBox", ".ilightbox-wrapper",
            function(a) {
                "mouseenter" == a.type ? c.lockWheel = !0 : c.lockWheel = !1
            }).on(clickEvent, ".ilightbox-toolbar a.ilightbox-close, .ilightbox-toolbar a.ilightbox-fullscreen, .ilightbox-toolbar a.ilightbox-play, .ilightbox-toolbar a.ilightbox-pause",
            function(a) {
                var c = $(this);
            ...
            }).on(touchMoveEvent, ".ilightbox-overlay, .ilightbox-thumbnails-container",
            function(a) {
                a.preventDefault()
            }),
            d.controls.arrows && !supportTouch && $doc.on("mousemove.iLightBox", a),
            d.controls.slideshow && d.slideshow.pauseOnHover && $doc.on("mouseenter.iLightBox mouseleave.iLightBox", ".ilightbox-holder:not(.ilightbox-next, .ilightbox-prev)",
            function(a) {
            ...
            d.controls.mousewheel && m.on("mousewheel.iLightBox",
            function(a, d) {
                c.lockWheel || (a.preventDefault(), 0 > d ? b.moveTo("next") : d > 0 && b.moveTo("prev"))
            }),
            d.controls.swipe && f.on(touchStartEvent,
            function(a) {
                function g(a) {
                    var b = $(this),
                    c = q[a],
        ...
        goTo: function(a) {
            ...
            if (d.infinite && (a == c.total - 1 && 0 == c.current && (e = -1), c.current == c.total - 1 && 0 == a && (e = 1)), 1 == e) b.moveTo("next");
                ...
                d.linkId && (c.hashLock = !0, window.location.hash = d.linkId + "/" + a),
                b.items[a] && (b.items[a].options.mousewheel ? b.vars.lockWheel = !1 : c.lockWheel = !0, b.items[a].options.swipe ? c.lockSwipe = !1 : c.lockSwipe = !0),
                $.each([c.holder, c.nextPhoto, c.prevPhoto],
                function(a, b) {
                ...
                $(".ilightbox-thumbnail", c.thumbnails).removeClass("ilightbox-active").eq(a).addClass("ilightbox-active"),
        ...
        moveTo: function(a) {
            ...
            if (n.length && n.stop().fadeOut(g,
            function() {
                $(this).remove()
            }), o.length && o.stop().fadeOut(g,
            function() {
                $(this).remove()
            }), b.items[h].caption) {
            ...
            r && (b.setSocial(r, b.items[h].URL, i), d.social.start && $("div.ilightbox-social", i).fadeIn(d.effects.fadeSpeed)),
            $.each([i, j, k],
            function(a, b) {
            ...
            w = parseInt(w * d.styles["next" == a ? "prevScale": "nextScale"]),
            z = "horizontal" == e ? parseInt(u / 2 - C.offsetY - w / 2 - y.H - x.H / 2) : parseInt(u - C.offsetX - y.H - x.H / 2),
            "prev" == a ? A = "horizontal" == e ? parseInt(t - C.offsetX - y.W - x.W / 2) : parseInt(t / 2 - v / 2 - y.W - C.offsetY - x.W / 2) : (z = "horizontal" == e ? z: parseInt(C.offsetX - y.H - w - x.H / 2), A = "horizontal" == e ? parseInt(C.offsetX - y.W - v - x.W / 2) : parseInt(t / 2 - C.offsetY - v / 2 - y.W - x.W / 2)),
            $("div.ilightbox-container", j).animate({
                width: v,
                height: w
            },
            g, c.isSwipe ? "easeOutCirc": "easeInOutCirc"),
            j.addClass(l).css(transform, gpuAcceleration).animate({
                top: z,
                left: A,
            ...
            function() {
                j.css(transform, ""),
                $(".ilightbox-thumbnail", c.thumbnails).removeClass("ilightbox-active").eq(h).addClass("ilightbox-active"),
                b.positionThumbnails(),
                b.items[h] && (b.items[h].options.mousewheel ? c.lockWheel = !1 : c.lockWheel = !0, b.items[h].options.swipe ? c.lockSwipe = !1 : c.lockSwipe = !0),
                c.isSwipe = !1,
                "next" == a ? (c.nextPhoto = k, c.prevPhoto = j, c.holder = i, c.nextPhoto.hide(), c.next = c.next + 1, c.prev = c.current, c.current = c.current + 1, d.infinite && (c.current > c.total - 1 && (c.current = 0), c.current == c.total - 1 && (c.next = 0), 0 == c.current && (c.prev = c.total - 1)), b.createUI(), b.items[c.next] ? b.loadContent(b.items[c.next], "next") : c.nextLock = !1) : (c.prevPhoto = k, c.nextPhoto = j, c.holder = i, c.prevPhoto.hide(), c.next = c.current, c.current = c.prev, c.prev = c.current - 1, d.infinite && (c.current == c.total - 1 && (c.next = 0), 0 == c.current && (c.prev = c.total - 1)), b.createUI(), b.items[c.prev] ? b.loadContent(b.items[c.prev], "prev") : c.prevLock = !1),
                d.linkId && setTimeout(function() {
                    c.hashLock = !1
                },
                55),
            ...
            z = "horizontal" == e ? getPixel(k, "top") : "next" == a ? parseInt( - (u / 2) - k.outerHeight()) : parseInt(2 * z),
            A = "horizontal" == e ? "next" == a ? parseInt( - (t / 2) - k.outerWidth()) : parseInt(2 * A) : getPixel(k, "left"),
        ...
        normalizeSocial: function(a, b) {
            ...
            function(c, f) {
                ...
                switch (i) {
                case "facebook":
                    g = "http://www.facebook.com/share.php?v=4&src=bm&u={URL}",
                    h = "Share on Facebook";
                    break;
                case "twitter":
                    g = "http://twitter.com/home?status={URL}",
                    h = "Share on Twitter";
                    break;
                case "googleplus":
                    ...
                    break;
                case "delicious":
                    g = "http://delicious.com/post?url={URL}",
                    h = "Share on Delicious";
                    break;
                case "digg":
                    g = "http://digg.com/submit?phase=2&url={URL}",
                    h = "Share on Digg";
                    break;
                case "reddit":
                    g = "http://reddit.com/submit?url={URL}",
                    h = "Share on reddit"
                }
                a[c] = {
        ...
        setSocial: function(a, b, c) {
            ...
            f += "</ul>",
            e.html(f),
            $("div.ilightbox-container", c).append(e)
        },
        ...
        doFullscreen: function() {
            ...
            if (d.fullAlone) {
                ...
                if (b.isInFullScreen) b.isInFullScreen = b.lockKey = b.lockWheel = b.lockSwipe = !1,
                b.overlay.css({
                ...
                b.fullScreenButton.attr("title", d.text.enterFullscreen),
                e.data({
                ...
                "function" == typeof d.callback.onExitFullScreen && d.callback.onExitFullScreen.call(a, a.ui);
                    ...
                    function(a, b) {
                        ...
                        if ("fill" == c.toLowerCase()) l = k / m * n,
                        h > l && (k = h / n * m, l = h);
                        else if ("fit" == c.toLowerCase()) {
                            var o = a.getNewDimenstions(k, l, m, n, !0);
                            k = o.width,
                            l = o.height
                        } else if ("stretch" == c.toLowerCase()) k = k,
                        l = l;
                        else {
                            var p = m > k || n > l ? !0 : !1,
        ...
        closeAction: function() {
            ...
            $doc.off(".iLightBox"),
            b.isInFullScreen && fullScreenApi.cancelFullScreen(document.documentElement),
            $(".ilightbox-overlay, .ilightbox-holder, .ilightbox-thumbnails").off(".iLightBox"),
            c.hide.effect ? b.overlay.stop().fadeOut(c.hide.speed,
            function() {
                b.overlay.remove(),
                b.BODY.removeClass("ilightbox-noscroll").off(".iLightBox")
            ...
            b.dontGenerateThumbs = b.isInFullScreen = !1,
            window.iLightBox = null,
            c.linkId && (b.hashLock = !0, removeHash(), setTimeout(function() {
                b.hashLock = !1
            },
            55)),
            "function" == typeof c.callback.onHide && c.callback.onHide.call(a, a.ui)
        },
        ...
        repositionEl: function(a) {
            ...
            m = a.thumbsOffsetW,
            n = a.thumbsOffsetH;
            "current" == a.type ? ("number" == typeof i.width && i.width && (f = c.isInFullScreen && d.fullAlone && ( - 1 != d.fullStretchTypes.indexOf(h.type) || i.fullViewPort || d.fullViewPort) ? f: i.width > f ? f: i.width), "number" == typeof i.height && i.height && (g = c.isInFullScreen && d.fullAlone && ( - 1 != d.fullStretchTypes.indexOf(h.type) || i.fullViewPort || d.fullViewPort) ? g: i.height > g ? g: i.height)) : ("number" == typeof i.width && i.width && (f = i.width > f ? f: i.width), "number" == typeof i.height && i.height && (g = i.height > g ? g: i.height)),
            g = parseInt(g - $(".ilightbox-inner-toolbar", j).outerHeight());
            ...
            d.effects.repositionSpeed, "easeOutCirc",
            function() {
                j.css(transform, "")
        ...
        resume: function(a) {
            var b = this,
            c = b.vars,
            d = b.options; ! d.slideshow.pauseTime || d.controls.slideshow && c.total <= 1 || a < c.isPaused || (c.isPaused = 0, c.cycleID && (c.cycleID = clearTimeout(c.cycleID)), c.cycleID = setTimeout(function() {
        ...
        getNewDimenstions: function(a, b, c, d, e) {
            var f = this;
            a ? b ? factor = min(a / c, b / d) : factor = a / c: factor = b / d,
            e || (factor > f.options.maxScale ? factor = f.options.maxScale: factor < f.options.minScale && (factor = f.options.minScale));
        ...
        setOption: function(a) {
            var b = this;
            b.options = $.extend(!0, b.options, a || {}),
            b.refresh()
        },
        ...
        addContent: function(a, b) {
            ...
            case "video":
                var e = !1,
                f = b.videoType,
                g = b.options.html5video; ("video/mp4" == f || "mp4" == b.ext || "m4v" == b.ext || g.h264) && d.plugins.html5H264 ? (b.ext = "mp4", b.URL = g.h264 || b.URL) : g.webm && d.plugins.html5WebM ? (b.ext = "webm", b.URL = g.webm || b.URL) : g.ogg && d.plugins.html5Vorbis && (b.ext = "ogv", b.URL = g.ogg || b.URL),
                !d.plugins.html5H264 || "video/mp4" != f && "mp4" != b.ext && "m4v" != b.ext ? !d.plugins.html5WebM || "video/webm" != f && "webm" != b.ext ? !d.plugins.html5Vorbis || "video/ogg" != f && "ogv" != b.ext ? !d.plugins.html5QuickTime || "video/quicktime" != f && "mov" != b.ext && "qt" != b.ext || (e = !0, f = "video/quicktime") : (e = !0, f = "video/ogg") : (e = !0, f = "video/webm") : (e = !0, f = "video/mp4"),
                e ? c = $("<video />", {
                    width: "100%",
                    height: "100%",
                    preload: g.preload,
            ...
            case "flash":
                if (d.plugins.flash) {
                    var h = "",
                    i = 0;
                    b.options.flashvars ? $.each(b.options.flashvars,
                    function(a, b) {
                        0 != i && (h += "&"),
                ...
                break;
            case "iframe":
                for (var j = b.URL.substring(b.URL.indexOf("?") + 1).split("&"), k = {},
                l = "?", m = 0; m < j.length; ++m) {
                    var n = j[m].split("=");
            ...
            return $("div.ilightbox-container", a).empty().html(c),
            "video" === c[0].tagName.toLowerCase() && browser.webkit && setTimeout(function() {
            ...
            function(a) {
                if (c.hideLoader(), a) {
                    ...
                    if (d.length = !1, d.url = a.url, 200 == a.status) {
                        ...
                        g = e.source;
                        d.type = f,
                        d.html5video = e.html5video || {},
                        d.length = !0,
                        e.images && (d.thumbnail = e.images[0]),
                        g && (d.source = g.src, d.width = g.width && parseInt(g.width) || 0, d.height = g.height && parseInt(g.height) || 0, d.thumbnail = g.thumbnail, "application/x-shockwave-flash" == g.type ? d.type = "flash": -1 != g.type.indexOf("video/") ? d.type = "video": -1 != g.type.indexOf("/html") ? d.type = "iframe": -1 != g.type.indexOf("image/") && (d.type = "image"))
        ...
        hashChangeHandler: function(a) {
            ...
            g = f.split("/"),
            h = g[1];
            if (! (c.hashLock || "#" + d.linkId != g[0] && f.length > 1)) if (h) {
                var i = g[1] || 0;
                if (b.items[i]) {
    ...
    function() {
        $.each("touchstart touchmove touchend tap taphold swipeleft swiperight scrollstart scrollstop".split(" "),
        function(a, b) {
            $.fn[b] = function(a) {
            ...
            setup: function() {
                ...
                function(f) {
                    ...
                    function(a) {
                        ...
                        a = $.event.fix(e),
                        a.type = "itap",
                        b && c && b.x == c.x && b.y == c.y && ($.event.dispatch || $.event.handle).call(d, a),
                        b = c = undefined
                    })
                })
            },
    ...
    function() {
        ...
        b = browserPrefixes.length; b > a; a++) if (fullScreenApi.prefix = browserPrefixes[a], "undefined" != typeof document[fullScreenApi.prefix + "CancelFullScreen"]) {
    ...
    function() {
        ...
        browser = {},
        b.browser && (browser[b.browser] = !0, browser.version = b.version),
    ...
    function() {
        ...
        gpuAcceleration = a("perspective") ? "translateZ(0) ": ""
    } ();
    var PluginDetect = {
        version: "0.7.9",
        name: "PluginDetect",
        ...
        formatNum: function(a, b) {
            ...
            for (e.isNum(b) || (b = 4), b--, d = a.replace(/\s/g, "").split(e.splitNumRegx).concat(["0", "0", "0", "0"]), c = 0; 4 > c; c++) / ^(0 + )(. + ) $ / .test(d[c]) && (d[c] = RegExp.$2),
        ...
        $$hasMimeType: function(a) {
            return function(b) {
                if (!a.isIE && b) {
                    ...
                    for (e = 0; e < f.length; e++) if (a.isString(f[e]) && /[^\s]/.test(f[e]) && (c = navigator.mimeTypes[f[e]], d = c ? c.enabledPlugin: 0, d && (d.name || d.description))) return c
                }
                return null
            }
        },
        findNavPlugin: function(a, b, c) {
            ...
            k = navigator.plugins,
            l = "";
            for (d = 0; d < k.length; d++) if (f = k[d].description || l, e = k[d].name || l, (h.test(f) && (!i || i.test(RegExp.leftContext + RegExp.rightContext)) || h.test(e) && (!i || i.test(RegExp.leftContext + RegExp.rightContext))) && (!j || !j.test(f) && !j.test(e))) return k[d];
            return null
        },
        getMimeEnabledPlugin: function(a, b, c) {
            ...
            l = h.isString(a) ? [a] : a;
            for (g = 0; g < l.length; g++) if ((d = h.hasMimeType(l[g])) && (d = d.enabledPlugin) && (f = d.description || j, e = d.name || j, (i.test(f) || i.test(e)) && (!k || !k.test(f) && !k.test(e)))) return d;
            return 0
        },
        ...
        convertFuncs: function(a) {
            ...
            for (b in a) if (d.test(b)) try {
                c = b.slice(2),
                c.length > 0 && !a[c] && (a[c] = a[b](a), delete a[b])
            } catch(e) {}
        },
        ...
        initScript: function() {
            ...
            if (b.convertFuncs(b), b.OS = 100, g) {
                ...
                for (a = i.length - 2; a >= 0; a -= 2) if (i[a] && new RegExp(i[a], "i").test(g)) {
                    b.OS = i[a + 1];
                    break
                }
            }
            if (b.head = d.getElementsByTagName("head")[0] || d.getElementsByTagName("body")[0] || d.body || null, b.isIE = new Function("return/*@cc_on!@*/!1")(), b.verIE = b.isIE && /MSIE\s*(\d+\.?\d*)/i.test(e) ? parseFloat(RegExp.$1, 10) : null, b.verIEfull = null, b.docModeIE = null, b.isIE) {
                ...
                try {
                    k.style.behavior = "url(#default#clientcaps)",
                    b.verIEfull = k.getComponentVersion("{89820200-ECBD-11CF-8B85-00AA005B4383}", "componentid").replace(/,/g, ".")
                } catch(l) {}
                j = parseFloat(b.verIEfull || "0", 10),
                b.docModeIE = d.documentMode || (/back/i.test(d.compatMode || "") ? 5 : j) || b.verIE,
                b.verIE = j || b.docModeIE
            }
            if (b.ActiveXEnabled = !1, b.isIE) {
                ...
                for (a = 0; a < m.length; a++) if (b.getAXO(m[a])) {
                    b.ActiveXEnabled = !0;
                    break
                }
            }
            b.isGecko = /Gecko/i.test(h) && /Gecko\s*\/\s*\d/i.test(e),
            b.verGecko = b.isGecko ? b.formatNum(/rv\s*\:\s*([\.\,\d]+)/i.test(e) ? RegExp.$1: "0.9") : null,
            b.isChrome = /Chrome\s*\/\s*(\d[\d\.]*)/i.test(e),
            b.verChrome = b.isChrome ? b.formatNum(RegExp.$1) : null,
            b.isSafari = (/Apple/i.test(f) || !f && !b.isChrome) && /Safari\s*\/\s*(\d[\d\.]*)/i.test(e),
            b.verSafari = b.isSafari && /Version\s*\/\s*(\d[\d\.]*)/i.test(e) ? b.formatNum(RegExp.$1) : null,
            b.isOpera = /Opera\s*[\/]?\s*(\d+\.?\d*)/i.test(e),
            b.verOpera = b.isOpera && (/Version\s*\/\s*(\d+\.?\d*)/i.test(e), !0) ? parseFloat(RegExp.$1, 10) : null,
            b.addWinEvent("load", b.handler(b.runWLfuncs, b))
        },
        init: function(a) {
            var b, a, c = this,
            d = {
        ...
        callArray: function(a) {
            var b, c = this;
            if (c.isArray(a)) for (b = 0; b < a.length; b++) {
                if (null === a[b]) return;
                c.call(a[b]),
                a[b] = null
            }
        ...
        isActiveXObject: function(a, b) {
            ...
            if (!c.head) return d;
            c.head.insertBefore(document.createElement("object"), c.head.firstChild),
            c.head.firstChild.outerHTML = e;
            try {
            ...
            return c.head.removeChild(c.head.firstChild),
            d
        },
        codebaseSearch: function(a, b) {
            ...
            if (j && i) for (f = 1; f < j.length && j[f - 1] == i[f - 1]; f++) i[f] < l[f] && (l[f] = i[f]),
            j[f] > k[f] && (k[f] = j[f]);
            if (e.max) for (f = 1; f < l.length; f++) if (i[f] > 0 && 0 == l[f] && l[f - 1] < e.digits[f - 1]) {
                l[f - 1] += 1;
                break
            }
            for (f = 0; f < l.length; f++) {
                for (h = {},
                g = 0; 20 > g && !(l[f] - k[f] < 1) && (d = round((l[f] + k[f]) / 2), !h["a" + d]); g++) h["a" + d] = 1,
                n(f, d) ? (k[f] = d, m = 1) : l[f] = d;
        ...
        runWLfuncs: function(a) {
            ...
            a.onDoneEmptyDiv && a.onDoneEmptyDiv()
        },
        winLoaded: !1,
        ...
        emptyDiv: function() {
            ...
            if (f.div && f.div.childNodes) for (a = f.div.childNodes.length - 1; a >= 0; a--) {
                if (c = f.div.childNodes[a], c && c.childNodes) for (b = c.childNodes.length - 1; b >= 0; b--) {
                    e = c.childNodes[b];
                    try {
                        c.removeChild(e)
                    } catch(g) {}
        ...
        setStyle: function(a, b) {
            var c, d = a.style;
            if (d && b) for (c = 0; c < b.length; c += 2) try {
                d[b[c]] = b[c + 1]
            } catch(e) {}
        },
        insertDivInBody: function(a, b) {
            ...
            if (!g) try {
                f.write('<div id="' + d + '">.' + c.openTag + "/div>"),
                e = f.getElementById(d)
            } catch(h) {}
            g = f.getElementsByTagName("body")[0] || f.body,
            g && (g.insertBefore(a, g.firstChild), e && g.removeChild(e))
        },
        ...
        Plugins: {
            quicktime: {
                ...
                getVersion: function(a) {
                    ...
                    f = null;
                    if (d.isIE) {
                        if (d.isStrNum(a) && (b = a.split(d.splitNumRegx), b.length > 3 && parseInt(b[3], 10) > 0 && (b[3] = "9999"), a = b.join(",")), d.isStrNum(a) && d.verIE >= c.minIEver && c.canUseIsMin() > 0) return c.installed = c.isMin(a),
                        void(c.getVersionDone = 0);
                        c.getVersionDone = 1,
                        !e && d.verIE >= c.minIEver && (e = c.CDBASE2VER(d.codebaseSearch(c))),
                        e || (f = d.getAXO(c.progID), f && f.QuickTimeVersion && (e = f.QuickTimeVersion.toString(16), e = parseInt(e.charAt(0), 16) + "." + parseInt(e.charAt(1), 16) + "." + parseInt(e.charAt(2), 16)))
                    } else d.hasMimeType(c.mimeType) && (f = 3 != d.OS ? d.findNavPlugin("QuickTime.*Plug-?in", 0) : null, f && f.name && (e = d.getNum(f.name)));
                    c.installed = e ? 1 : f ? 0 : -1,
                    c.version = d.formatNum(e, 3)
                },
                ...
                CDBASE2VER: function(a) {
                    ...
                    e = c.cdbaseUpper,
                    f = c.cdbaseLower;
                    if (a) for (a = d.formatNum(a), b = 0; b < e.length; b++) if (e[b] && d.compareNums(a, e[b]) < 0 && f[b] && d.compareNums(a, f[b]) >= 0 && c.cdbase2ver[b]) return c.cdbase2ver[b](c, a);
                    return a
                },
                canUseIsMin: function() {
                    ...
                    e = b.cdbaseUpper,
                    f = b.cdbaseLower;
                    if (!d.value) for (d.value = -1, a = 0; a < e.length; a++) {
                    ...
                    return b.SEARCH.match = 1 == d.value ? 1 : 0,
                    d.value
                },
                isMin: function(a) {
                    var b = this,
            ...
            flash: {
                ...
                getVersion: function() {
                    ...
                    j = null;
                    if (g.isIE) {
                        for (a = 15; a > 2; a--) if (i = g.getAXO(f.progID + "." + a)) {
                            j = a.toString();
                            break
                        }
                    ...
                    return f.installed = h ? 1 : -1,
                    f.version = g.formatNum(h),
                    !0
                }
            },
            shockwave: {
                ...
                getVersion: function() {
                    ...
                    } else a = e.findNavPlugin("Shockwave\\s*for\\s*Director"),
                    a && a.description && e.hasMimeType(d.mimeType) && (b = e.getNum(a.description)),
                    b && (b = e.getPluginFileVersion(a, b));
                    d.installed = b ? 1 : -1,
                    d.version = e.formatNum(b)
                }
            },
            zz: 0
        }
    ...
    function() {
        ...
        d.iLightBoxHashChange = $.extend(d.iLightBoxHashChange, {
            setup: function() {
        ...
        b = function() {
            function b() {
                var c = a(),
                e = j(g);
                c !== g ? (i(g = c, e), $(window).trigger("iLightBoxHashChange")) : e !== g && (location.href = location.href.replace(/#.*/, "") + e),
                d = setTimeout(b, $.fn.iLightBoxHashChange.delay)
            }
            var d, e = {},
            g = a(),
            h = function(a) {
            ...
            function() {
                var d, f;
                e.start = function() {
                    d || (f = (f = $.fn.iLightBoxHashChange.src) && f + a(), d = $('<iframe tabindex="-1" title="empty"/>').hide().one("load",
                    function() {
                        f || i(a()),
                        b()
    ...
    Array.prototype.lastIndexOf || (Array.prototype.lastIndexOf = function(a) {
        ...
        for (var e = d >= 0 ? min(d, c - 1) : c - abs(d); e >= 0; e--) if (e in b && b[e] === a) return e;
        return - 1
    })
} (jQuery, this);
var $avada_lightbox = {},
...
$avada_lightbox.activate_lightbox = function(a) {
    ...
    a.find(".tiled-gallery").each(function() {
        jQuery(this).find(".tiled-gallery-item > a").each(function() {
            ...
            null == a && (a = "iLightbox[tiled-gallery-" + c + "]", jQuery(this).attr("data-rel", a)),
            -1 === jQuery.inArray(a, b) && b.push(a)
        }),
        c++
    }),
    jQuery.each(b,
    ...
    Boolean(Number(js_local_vars.lightbox_post_images)) && a.find(".type-post .post-content a, #posts-container .post .post-content a, .fusion-blog-shortcode .post .post-content a").has("img").each(function() {
        for (var a = ["bmp", "gif", "jpeg", "jpg", "png", "tiff", "tif", "jfif", "jpe", "svg", "mp4", "ogg", "webm"], b = 0, c = 0; c < a.length; c++) b += String(jQuery(this).attr("href")).toLowerCase().indexOf("." + a[c]); - 13 == b && jQuery(this).addClass("fusion-no-lightbox"),
...
$avada_lightbox.prepare_options = function(a, b) {
    ...
    Boolean(Number(js_local_vars.lightbox_deeplinking)) && (e.linkId = a),
    e
},
$avada_lightbox.refresh_lightbox = function() {
    $avada_lightbox.set_title_and_caption(),
    jQuery.each($il_instances,
    function(a, b) {
...
jQuery(document).ajaxComplete(function() {
    ...
    1 == Number(js_local_vars.avada_styles_dropdowns) && (jQuery(".woocommerce-billing-fields, .woocommerce-shipping-fields").addClass("avada-select"), jQuery(".woocommerce.widget_product_categories select").length && jQuery(".woocommerce.widget_product_categories select").wrap('<p class="avada-select-parent"></p>').after('<div class="select-arrow">&#xe61f;</div>'), jQuery(".cart-collaterals select#calc_shipping_country, .widget_layered_nav select").wrap('<p class="avada-select-parent"></p>').after('<div class="select-arrow">&#xe61f;</div>'), jQuery(".cart-collaterals select#calc_shipping_state").after('<div class="select-arrow">&#xe61f;</div>'), setTimeout(function() {
        jQuery("#billing_country_field .chosen-container").length || jQuery("#billing_country_field .select2-container").length || (jQuery("#billing_country_field select.country_select").wrap('<p class="avada-select-parent"></p>').after('<span class="select-arrow">&#xe61f;</span>'), !jQuery("#billing_state_field select.state_select").length || jQuery("#billing_state_field .chosen-container").length || jQuery("#billing_state_field .select2-container").length || jQuery("#billing_state_field").addClass("avada-select-parent").append('<div class="select-arrow">&#xe61f;</div>'), jQuery("#billing_country").change(function() {
            setTimeout(function() { (jQuery("#billing_state_field input#billing_state").length || jQuery("#billing_state_field").is(":hidden")) && (jQuery("#billing_state_field .select-arrow").remove(), jQuery("#billing_state_field").removeClass("avada-select-parent")),
                jQuery("#billing_state_field select.state_select").length && (jQuery("#billing_state_field").addClass("avada-select-parent"), jQuery("#billing_state_field .select-arrow").length || (jQuery("#billing_state_field").append('<div class="select-arrow">&#xe61f;</div>'), calc_select_arrow_dimensions()))
            },
            1)
        })),
        jQuery("#shipping_country_field .chosen-container").length || jQuery("#shipping_country_field .select2-container").length || (jQuery("#shipping_country_field select.country_select").wrap('<p class="avada-select-parent"></p>').after('<span class="select-arrow">&#xe61f;</span>'), jQuery("#shipping_state_field select.state_select").length && jQuery("#shipping_state_field").addClass("avada-select-parent").append('<div class="select-arrow">&#xe61f;</div>'), jQuery("#shipping_country").change(function() {
            setTimeout(function() { (jQuery("#shipping_state_field input#shipping_state").length || jQuery("#shipping_state_field").is(":hidden")) && (jQuery("#shipping_state_field .select-arrow").remove(), jQuery("#shipping_state_field").removeClass("avada-select-parent")),
                jQuery("#shipping_state_field select.state_select").length && (jQuery("#shipping_state_field").addClass("avada-select-parent"), jQuery("#shipping_state_field .select-arrow").length || (jQuery("#shipping_state_field").append('<div class="select-arrow">&#xe61f;</div>'), calc_select_arrow_dimensions()))
            },
            1)
        }))
    },
    1), jQuery("#calc_shipping_country").change(function() {
        setTimeout(function() {
            jQuery(".avada-shipping-calculator-form select#calc_shipping_state").length && !jQuery(".avada-shipping-calculator-form #calc_shipping_state").parent().find(".select-arrow").length && jQuery(".avada-shipping-calculator-form select#calc_shipping_state").after('<div class="select-arrow">&#xe61f;</div>'),
            jQuery(".avada-shipping-calculator-form input#calc_shipping_state").length && jQuery(".avada-shipping-calculator-form #calc_shipping_state").parent().children(".select-arrow").remove(),
            calc_select_arrow_dimensions()
        },
        1)
    ...
    }), jQuery(".widget_categories select, .widget_archive select ").css("width", "100%"), jQuery(".widget_categories select, .widget_archive select ").wrap('<div class="avada-select-parent"></div>').after('<div class="select-arrow">&#xe61f;</div>')),
    calc_select_arrow_dimensions(),
    setTimeout(function() {
        calc_select_arrow_dimensions()
    },
    100)
}), jQuery(document).bind("gform_post_conditional_logic",
function() {
    ...
    jQuery(".bbp-template-notice").each(function() {
        jQuery(this).hasClass("info") ? jQuery(this).attr("class", "fusion-alert alert notice alert-dismissable alert-info alert-shadow") : jQuery(this).attr("class", "fusion-alert alert notice alert-dismissable alert-warning alert-shadow"),
        ...
        jQuery(this).children(".close").click(function(a) {
            a.preventDefault(),
    ...
    jQuery.trim(jQuery(".tribe-events-nav-previous").html()).length || jQuery.trim(jQuery(".tribe-events-nav-next").html()).length || jQuery(".tribe-events-sub-nav").parent().hide(),
    ...
    jQuery(".product-images").each(function() { ! jQuery(this).find("img").length && jQuery(this).find(".onsale").length && jQuery(this).css("min-height", "45px")
    }),
    jQuery(".woocommerce .images #carousel a").click(function(a) {
        a.preventDefault()
    }),
    jQuery(".variations_form").on("change", ".variations select",
    function(a) {
        ...
        setTimeout(function() {
            ...
            b && b.attr("href") && (c = b.attr("href")),
            a.parent().attr("href", c),
            a.removeAttr("sizes"),
            a.removeAttr("srcset"),
            $avada_lightbox.refresh_lightbox(),
            d.attr("src", c),
    ...
    jQuery(".fusion-update-cart").on("click",
    function(a) {
        a.preventDefault(),
        jQuery(".cart .actions > .button").trigger("click")
    }),
    jQuery(".fusion-apply-coupon").on("click",
    function(a) {
        a.preventDefault(),
    ...
    jQuery("body").on("click", ".add_to_cart_button",
    function(a) {
        var b = jQuery(this);
        b.closest(".product, li").find(".cart-loading").find("i").removeClass("fusion-icon-check-square-o").addClass("fusion-icon-spinner"),
        b.closest(".product, li").find(".cart-loading").fadeIn(),
        setTimeout(function() {
            b.closest(".product, li").find(".cart-loading").find("i").hide().removeClass("fusion-icon-spinner").addClass("fusion-icon-check-square-o").fadeIn(),
            jQuery(b).parents(".fusion-clean-product-image-wrapper, li").addClass("fusion-item-in-cart")
        },
        2e3)
    }),
    ...
    b.indexOf("underline") > -1 && (c = b),
    jQuery("body").hasClass("rtl") && (d = "title-heading-right"),
    ...
    "block" == jQuery("body .sidebar").css("display") && fusion_calc_woocommerce_tabs_layout(".woocommerce-tabs .tabs-horizontal"),
    ...
    jQuery("body").on("click", ".woocommerce-tabs > ul.tabs li a",
    function() {
        var a = jQuery(this),
    ...
    jQuery(".woocommerce-checkout-nav a,.continue-checkout").on("click",
    function(a) {
        ...
        }), a.preventDefault(), jQuery(".avada-checkout-error").parent().remove(), jQuery(".woocommerce .avada-checkout").find(".woocommerce-invalid").is(":visible")) jQuery(".woocommerce .avada-checkout .woocommerce-checkout").prepend('<ul class="woocommerce-error"><li class="avada-checkout-error">' + js_local_vars.woocommerce_checkout_error + "</li><ul>"),
    ...
    f.hasClass("address") ? jQuery(".avada-myaccount-data .edit_address_heading").fadeIn() : jQuery(".avada-myaccount-data h2:nth-of-type(1)").fadeIn(),
    f.hasClass("downloads") ? jQuery(".avada-myaccount-data .digital-downloads").fadeIn() : f.hasClass("orders") ? jQuery(".avada-myaccount-data .my_account_orders").fadeIn() : f.hasClass("address") ? jQuery(".avada-myaccount-data .myaccount_address, .avada-myaccount-data .address").fadeIn() : f && (jQuery(".avada-myaccount-data .edit-account-form, .avada-myaccount-data .edit-account-heading").fadeIn(), jQuery(".avada-myaccount-data h2:nth-of-type(1)").hide()),
    jQuery(".avada-myaccount-nav.avada-woocommerce-pre26 a").on("click",
    function(a) {
        a.preventDefault(),
        ...
        jQuery(this).hasClass("downloads") ? jQuery(".avada-myaccount-data h2:nth-of-type(1), .avada-myaccount-data .digital-downloads").fadeIn() : jQuery(this).hasClass("orders") ? (jQuery(this).parents(".avada-myaccount-nav").find(".downloads").length ? heading = jQuery(".avada-myaccount-data h2:nth-of-type(2)") : heading = jQuery(".avada-myaccount-data h2:nth-of-type(1)"), heading.fadeIn(), jQuery(".avada-myaccount-data .my_account_orders").fadeIn()) : jQuery(this).hasClass("address") ? (jQuery(this).parents(".avada-myaccount-nav").find(".downloads").length && jQuery(this).parents(".avada-myaccount-nav").find(".orders").length ? heading = jQuery(".avada-myaccount-data h2:nth-of-type(3)") : jQuery(this).parents(".avada-myaccount-nav").find(".downloads").length || jQuery(this).parents(".avada-myaccount-nav").find(".orders").length ? heading = jQuery(".avada-myaccount-data h2:nth-of-type(2)") : heading = jQuery(".avada-myaccount-data h2:nth-of-type(1)"), heading.fadeIn(), jQuery(".avada-myaccount-data .myaccount_address, .avada-myaccount-data .address").fadeIn()) : jQuery(this).hasClass("account") && jQuery(".avada-myaccount-data .edit-account-heading, .avada-myaccount-data .edit-account-form").fadeIn(),
...
function(a, b, c, d) {
    function e(b, c) {
        ...
        this.settings.xpos = d[0],
        2 == d.length ? this.settings.ypos = d[1] : this.settings.ypos = "center",
        this._defaults = g,
        this._name = f,
        this.init()
    }
    ...
    a.extend(e.prototype, {
        init: function() {
            "" === this.settings.target && (this.settings.target = a(this.element)),
            "" === this.settings.image && "undefined" != typeof a(this.element).css("backgroundImage") && "" !== a(this.element).css("backgroundImage") && (this.settings.image = a(this.element).css("backgroundImage").replace(/url\(|\)|"|'/g, "")),
        ...
        setup: function() {
            this.settings.removeOrig !== !1 && a(this.element).remove(),
        ...
        doParallax: function() {
            ...
            if (this.isInView()) {
                ...
                if (0 === this.containerWidth || 0 === this.containerHeight || b === this.containerWidth && c === this.containerHeight || this.resizeParallaxBackground(), this.containerWidth = b, this.containerHeight = c, "undefined" != typeof a && 0 !== a.length) {
                    ...
                    e = this.moveMax * d;
                    "down" === this.settings.direction && (e *= 1.25),
                    ("left" == this.settings.direction || "up" == this.settings.direction) && (e *= -1);
                    var f = "translate3d(",
                    g = "px, -2px, 0px)",
                    h = "translate3d(0px, ",
                    i = "px, 0px)";
                    "undefined" != typeof _fusionParallaxIE9 && (f = "translate(", g = "px, 0px)", h = "translate(0px, ", i = "px)"),
                    "no-repeat" == a.css("background-repeat") && ("down" == this.settings.direction && 0 > e ? e = 0 : "up" == this.settings.direction && e > 0 ? e = 0 : "right" == this.settings.direction && 0 > e ? e = 0 : "left" == this.settings.direction && e > 0 && (e = 0)),
                    "fixed" === this.settings.direction || ("left" === this.settings.direction || "right" === this.settings.direction ? a.css({
        ...
        resizeParallaxBackground: function() {
            ...
            if ("undefined" != typeof a && 0 !== a.length) {
                ...
                if ("none" === this.settings.direction) {
                    ...
                    e = a.offset().left;
                    "center" === this.settings.align ? e = "50% 50%": "left" === this.settings.align ? e = "0% 50%": "right" === this.settings.align ? e = "100% 50%": "top" === this.settings.align ? e = "50% 0%": "bottom" === this.settings.align && (e = "50% 100%"),
                    a.css({
                ...
                "" !== this.settings.image && "none" !== this.settings.image && a.attr("style", "background-image: url(" + this.settings.image + ") !important;" + a.attr("style"));
                    ...
                    var h = 0;
                    "right" === this.settings.direction && (h -= d - g),
                    a.find(".parallax-inner").length < 1 && a.prepend('<div class="parallax-inner"></div>'),
                    a.css({
                        position: "relative",
                        overflow: "hidden",
                        zIndex: 1,
                    ...
                    var m = 0;
                    "down" === this.settings.direction && (m -= f - l),
                    a.find(".parallax-inner").length < 1 && a.prepend('<div class="parallax-inner"></div>'),
                    a.css({
                        position: "relative",
                        overflow: "hidden",
...
jQuery(document).ready(function(a) {
    ...
    a(window).on("scroll touchmove touchstart touchend gesturechange",
    function(a) {
        requestAnimationFrame(_fusionParallaxAll)
    }),
    (Modernizr.touch && jQuery(window).width() <= 1024 || window.screen.width <= 1281 && window.devicePixelRatio > 1) && requestAnimationFrame(b),
    a(window).on("resize",
    function() {
        setTimeout(function() {
            var a = jQuery;
...
jQuery(document).ready(function(a) {
    ...
    b() && a(".fusion-bg-parallax.video > div").remove(),
    a(".fusion-bg-parallax").next().addClass("bg-parallax-parent"),
    a(".fusion-bg-parallax").attr("style", "").css("display", "none"),
    a(".fusion-bg-parallax").each(function() {
...
jQuery(document).ready(function(a) {
    function b(a) {
        ...
        c = $f(a);
        "yes" == jQuery(b).data("mute") && c.api("setVolume", "0"),
        "no" == jQuery(b).data("mute") && c.api("setVolume", "1"),
        c.addEvent("playProgress",
        function(a, c) {
    ...
    if (!a("body").hasClass("vc_editor")) {
        a(".bg-parallax.video, .fusion-bg-parallax.video").each(function() {
            a(this).prependTo(a(this).next().addClass("video")),
            a(this).css({
        ...
        if (d.length > 0) {
            var e = "http:";
            "true" == js_local_vars.is_ssl && (e = "https:"),
            a.getScript(e + "//a.vimeocdn.com/js/froogaloop2.min.js?97273-1352487961").done(function(a, c) {
                for (var d, e = document.querySelectorAll("iframe"), f = 0, g = e.length; g > f; f++) d = e[f],
                jQuery("html").hasClass("ua-ie-11") && jQuery(d).parent().css("visibility", "visible"),
                $f(d).addEvent("ready", b)
            })
        }
    }
}),
...
jQuery(document).ready(function() {
    ...
    function b() {
        ...
        "0" == js_local_vars.header_sticky && (jQuery(".fusion-header-v6 .fusion-header").css({
            position: "fixed",
            width: "100%",
            "max-width": "100%",
            top: a,
    ...
    function c() {
        setTimeout(function() {
            ...
            "0" == js_local_vars.header_sticky && (jQuery(".fusion-header-v6 .fusion-header").attr("style", ""), jQuery(".fusion-header-sticky-height").attr("style", "")),
        ...
        return "Top" === js_local_vars.header_position && !jQuery("body.rtl").length || "Left" === js_local_vars.header_position ? jQuery(this).children(".sub-menu").each(function() {
            ...
            if (a.length) {
                ...
                j > l ? (a.parent().parent(".sub-menu").parent().parent(".sub-menu").length ? a.css({
                    ...
                    left: -1 * h
                }) : a.css("left", -1 * h + a.parent().width()), a.data("shifted", 1)) : a.parent().parent(".sub-menu").length && a.parent().parent(".sub-menu").data("shifted") && (a.css("left", -1 * h), a.data("shifted", 1)),
                "Top" !== js_local_vars.header_position && i > m + k && jQuery(window).height() >= jQuery(".side-header-wrapper").height() && (c = k > g ? -1 * (i - m - k + 20) : -1 * (f - b), a.css("top", c))
            }
            ...
            return jQuery("body.rtl").length ? this.each(function() {
                jQuery(this).children("li").each(function() {
                    ...
                    if (d.length) {
                        d.removeAttr("style");
                        var i;
                        i = jQuery(".fusion-secondary-main-menu").length ? jQuery(".fusion-header-wrapper .fusion-secondary-main-menu .fusion-row") : jQuery(".fusion-header-wrapper .fusion-row"),
                        d.hasClass("col-span-12") && i.width() < d.data("maxwidth") ? d.css("width", i.width()) : d.removeAttr("style"),
                        f > c - e && (h = -1 * (e - (c - f)), ("left" == js_local_vars.logo_alignment.toLowerCase() || "center" == js_local_vars.logo_alignment.toLowerCase() && !jQuery(".header-v5").length || jQuery(this).parents(".sticky-header").length) && c - h > g && (h = -1 * (g - c)), d.css("right", h))
                    }
                })
            }) : this.each(function() {
                jQuery(this).children("li").each(function() {
                    ...
                    if (c.length) {
                        ...
                        d = c.outerWidth(),
                        b.left + d > g && (e = -1 * (b.left - (g - d)), "right" == js_local_vars.logo_alignment.toLowerCase() && b.left + e < f && (e = -1 * (b.left - f)), c.css("left", e))
                    }
                })
            })
        }
    ...
    jQuery.fn.position_last_top_menu_item = function(a) {
        if (jQuery(this).children("ul").length || jQuery(this).children("div").length) {
            ...
            f = e.position().left,
            g = e.outerWidth();
            c.children("ul").length ? b = c.children("ul") : c.children("div").length && (b = c.children("div")),
            jQuery("body.rtl").length ? b.position().left < d && (b.css("left", "-1px").css("right", "auto"), b.find(".sub-menu").each(function() {
    ...
    cssua.ua.ie && "8" == cssua.ua.ie.substr(0, 1) && jQuery(".fusion-header-shadow").removeClass("fusion-header-shadow"),
    ...
    jQuery(".fusion-mobile-nav-holder").not(".fusion-mobile-sticky-nav-holder").each(function() {
        ...
        c.length && ("classic" == js_local_vars.mobile_menu_design && (a.append('<div class="fusion-mobile-selector"><span>' + js_local_vars.dropdown_goto + "</span></div>"), jQuery(this).find(".fusion-mobile-selector").append('<div class="fusion-selector-down"></div>')), jQuery(a).append(jQuery(c).find("> ul").clone()), b = jQuery(a).find("> ul"), b.find(".fusion-caret, .fusion-menu-login-box .fusion-custom-menu-item-contents, .fusion-menu-cart .fusion-custom-menu-item-contents, .fusion-main-menu-search, li> a > span > .button-icon-divider-left, li > a > span > .button-icon-divider-right").remove(), "classic" == js_local_vars.mobile_menu_design ? b.find(".fusion-menu-cart > a").html(js_local_vars.mobile_nav_cart) : b.find(".fusion-main-menu-cart").remove(), b.find("li").each(function() {
            ...
            var a = "fusion-mobile-nav-item"; (jQuery(this).hasClass("current-menu-item") || jQuery(this).hasClass("current-menu-parent") || jQuery(this).hasClass("current-menu-ancestor")) && (a += " fusion-mobile-current-nav-item"),
    ...
    jQuery(".fusion-mobile-sticky-nav-holder").each(function() {
        ...
        "classic" == js_local_vars.mobile_menu_design && (a.append('<div class="fusion-mobile-selector"><span>' + js_local_vars.dropdown_goto + "</span></div>"), jQuery(this).find(".fusion-mobile-selector").append('<div class="fusion-selector-down"></div>')),
        jQuery(a).append(jQuery(c).find("> ul").clone()),
        b = jQuery(a).find("> ul"),
        b.find(".fusion-menu-cart, .fusion-menu-login-box, .fusion-main-menu-search").remove(),
    ...
    1 == js_local_vars.submenu_slideout && (jQuery(".fusion-mobile-nav-holder > ul li").each(function() {
        var a = "fusion-mobile-nav-item"; (jQuery(this).hasClass("current-menu-item") || jQuery(this).hasClass("current-menu-parent") || jQuery(this).hasClass("current-menu-ancestor") || jQuery(this).hasClass("fusion-mobile-current-nav-item")) && (a += " fusion-mobile-current-nav-item"),
        jQuery(this).attr("class", a),
        jQuery(this).find(" > ul").length && (jQuery(this).prepend('<span href="#" aria-haspopup="true" class="fusion-open-submenu"></span>'), jQuery(this).find(" > ul").hide())
    }), jQuery(".fusion-mobile-nav-holder .fusion-open-submenu").click(function(a) {
        a.stopPropagation(),
        jQuery(this).parent().children(".sub-menu").slideToggle(200, "easeOutQuad")
    })),
    jQuery(".fusion-flyout-menu-icons .fusion-flyout-menu-toggle").on("click",
    function() {
    ...
    jQuery(".fusion-flyout-menu-icons .fusion-flyout-search-toggle").on("click",
    function() {
        var a = jQuery(this).parents(".fusion-header-v6");
...
jQuery(window).load(function() {
    ...
    if ("1" == js_local_vars.header_sticky && (jQuery(".fusion-header-wrapper").length >= 1 || jQuery("#side-header").length >= 1)) {
        ...
        window.$header_parent_height = c.outerHeight(),
        ...
        } (jQuery(".fusion-header-v4").length >= 1 || jQuery(".fusion-header-v5").length >= 1) && (window.$sticky_header_type = 2, "menu_and_logo" == js_local_vars.header_sticky_type2_layout || Modernizr.mq("only screen and (max-width: " + js_local_vars.side_header_break_point + "px)") && "modern" == js_local_vars.mobile_menu_design ? window.$sticky_trigger = jQuery(".fusion-sticky-header-wrapper") : window.$sticky_trigger = jQuery(".fusion-secondary-main-menu"), window.$sticky_trigger_position = Math.round(window.$sticky_trigger.offset().top) - window.$wp_adminbar_height - window.$woo_store_notice),
        1 == window.$sticky_header_type && (Modernizr.mq("only screen and (max-width: " + js_local_vars.side_header_break_point + "px)") ? window.$scrolled_header_height = window.$header_height: window.$original_sticky_trigger_height = jQuery(window.$sticky_trigger).outerHeight()),
        2 == window.$sticky_header_type && ("classic" == js_local_vars.mobile_menu_design && jQuery(c).height(window.$header_parent_height), Modernizr.mq("only screen and (max-width: " + js_local_vars.side_header_break_point + "px)") ? window.$scrolled_header_height = window.$header_parent_height: jQuery(c).height(window.$header_parent_height)),
        jQuery("#side-header").length >= 1 && (window.$sticky_header_type = 3),
        jQuery(document).height() - (window.$initial_desktop_header_height - window.$scrolled_header_height) < jQuery(window).height() && 1 == js_local_vars.sticky_header_shrinkage ? (window.$sticky_can_be_shrinked = !1, jQuery(".fusion-header-wrapper").removeClass("fusion-is-sticky")) : window.$sticky_can_be_shrinked = !0;
        ...
        jQuery(window).resize(function() {
            if (window.$media_query_test_1 = Modernizr.mq("only screen and (min-device-width: 768px) and (max-device-width: 1366px) and (orientation: portrait)") || Modernizr.mq("only screen and (min-device-width: 768px) and (max-device-width: 1024px) and (orientation: landscape)"), window.$media_query_test_2 = Modernizr.mq("screen and (max-width: " + js_local_vars.side_header_break_point + "px)"), window.$media_query_test_3 = Modernizr.mq("screen and (max-width: " + js_local_vars.side_header_break_point + "px)"), window.$media_query_test_4 = Modernizr.mq("only screen and (max-width: " + js_local_vars.side_header_break_point + "px)"), "1" != js_local_vars.header_sticky_tablet && window.$media_query_test_1 ? (jQuery(".fusion-header-wrapper, .fusion-header-sticky-height, .fusion-header, .fusion-logo, .fusion-header-wrapper .fusion-main-menu > li a, .fusion-header-wrapper .fusion-secondary-main-menu").attr("style", ""), jQuery(".fusion-header-wrapper").removeClass("fusion-is-sticky")) : "1" == js_local_vars.header_sticky_tablet && window.$media_query_test_1 && (b = 0), "1" != js_local_vars.header_sticky_mobile && window.$media_query_test_2 ? (jQuery(".fusion-header-wrapper, .fusion-header-sticky-height, .fusion-header, .fusion-logo, .fusion-header-wrapper .fusion-main-menu > li a, .fusion-header-wrapper .fusion-secondary-main-menu").attr("style", ""), jQuery(".fusion-header-wrapper").removeClass("fusion-is-sticky")) : "1" == js_local_vars.header_sticky_mobile && window.$media_query_test_2 && (b = 0), jQuery(window).width() != j || jQuery(window).height() != k) {
                ...
                if (jQuery("#wpadminbar").length ? window.$wp_adminbar_height = jQuery("#wpadminbar").height() : window.$wp_adminbar_height = 0, window.$woo_store_notice = jQuery(".demo_store").length ? jQuery(".demo_store").outerHeight() : 0, jQuery(".fusion-is-sticky").length) {
                    ...
                    2 == window.$sticky_header_type && (e = "menu_only" != js_local_vars.header_sticky_type2_layout || "classic" != js_local_vars.mobile_menu_design && window.$media_query_test_4 ? jQuery(".fusion-sticky-header-wrapper") : jQuery(".fusion-secondary-main-menu")),
                    jQuery("#wpadminbar").length && (jQuery(".fusion-header, .fusion-sticky-header-wrapper, .fusion-secondary-main-menu").css("top", ""), jQuery(e).css("top", window.$wp_adminbar_height + window.$woo_store_notice)),
                    "boxed" === js_local_vars.layout_mode && jQuery(e).css("max-width", jQuery("#wrapper").outerWidth() + "px")
                }
                ...
                if (jQuery(document).height() - (window.$initial_desktop_header_height - window.$scrolled_header_height) < jQuery(window).height() && 1 == js_local_vars.sticky_header_shrinkage) window.$sticky_can_be_shrinked = !1,
            ...
            if (window.$sticky_can_be_shrinked) {
                ...
                if (0 == jQuery(".fusion-is-sticky").length && jQuery(".fusion-header, .fusion-secondary-main-menu").find(".fusion-mobile-nav-holder > ul").is(":visible") && (window.$sticky_trigger_position = Math.round(jQuery(".fusion-header, .fusion-sticky-header-wrapper").find(".fusion-mobile-nav-holder:visible").offset().top) - window.$wp_adminbar_height - window.$woo_store_notice + jQuery(".fusion-header, .fusion-sticky-header-wrapper").find(".fusion-mobile-nav-holder:visible").height()), 3 == window.$sticky_header_type || 0 != jQuery(".fusion-is-sticky").length || jQuery(".fusion-header, .fusion-secondary-main-menu").find(".fusion-mobile-nav-holder > ul").is(":visible") || (window.$sticky_trigger = jQuery(".fusion-header"), window.$sticky_trigger_position = Math.round(window.$sticky_trigger.offset().top) - window.$wp_adminbar_height - window.$woo_store_notice, 2 == window.$sticky_header_type && ("menu_and_logo" == js_local_vars.header_sticky_type2_layout || window.$media_query_test_4 && "modern" == js_local_vars.mobile_menu_design ? window.$sticky_trigger = jQuery(".fusion-sticky-header-wrapper") : window.$sticky_trigger = jQuery(".fusion-secondary-main-menu"), window.$sticky_trigger_position = Math.round(window.$sticky_trigger.offset().top) - window.$wp_adminbar_height - window.$woo_store_notice), "modern" != js_local_vars.mobile_menu_design || 2 != window.$sticky_header_type || !window.$media_query_test_4 && "menu_and_logo" != js_local_vars.header_sticky_type2_layout || (window.$header_height = jQuery(window.$sticky_trigger).outerHeight(), window.$scrolled_header_height = window.$header_height, jQuery(".fusion-header-sticky-height").css("height", window.$scrolled_header_height).show())), jQuery(window).scrollTop() > window.$sticky_trigger_position) {
                    if (0 == g) {
                        ...
                        3 == window.$sticky_header_type && Modernizr.mq("only screen and (max-width:" + js_local_vars.side_header_break_point + "px)") && (jQuery("#side-header-sticky").css({
...
jQuery(document).ajaxComplete(function() {
    if (jQuery(window).trigger("scroll"), jQuery(".fusion-is-sticky").length >= 1 && window.$sticky_trigger && 3 != window.$sticky_header_type) {
        ...
        c = a.height() - b;
        2 == window.$sticky_header_type && (a = jQuery(".fusion-secondary-main-menu"), c = a.find(".fusion-main-menu > ul > li > a").height()),
        jQuery(".fusion-main-menu > ul > li > a").css({
            height: c + "px",
            "line-height": c + "px"
        })
...
var generate_carousel = function() {
    jQuery().carouFredSel && jQuery(".fusion-carousel").each(function() {
        ...
        Math.floor(l / k);
        jQuery(this).find(".fusion-carousel-positioner").css("margin-left", "-" + j + "px"),
        jQuery(this).find(".fusion-carousel-item").css("margin-left", j + "px"),
        jQuery(this).find(".fusion-nav-prev").css("margin-left", j + "px"),
        jQuery(this).find("ul").carouFredSel({
            ...
            onCreate: function(c) {
                ...
                b && jQuery(this).css("line-height", jQuery(this).parent().height() + "px"),
...
fusion_calculate_responsive_type_values = function(a, b, c, d) {
    ...
    i = c || 0 === c ? c: 800,
    j = function() {
        if (jQuery(window).width() >= i) if (js_local_vars.site_width.indexOf("px")) var a = parseInt(js_local_vars.site_width);
        else var a = 1100;
        else var a = i;
    ...
    j(),
    jQuery(window).on("resize orientationchange", j)
};
$top = $bottom = !1,
...
function(a) {
    ...
    a(".tfs-slider").each(function() {
        var b = this;
        a(b).parents(".post-content").length >= 1 && (a(b).data("parallax", 0), a(b).data("full_screen", 0)),
        cssua.ua.tablet_pc && a(b).data("parallax", 0),
        cssua.ua.mobile && a(b).data("parallax", 0)
    }),
    a.fn.init_waypoint = function() {
        a().waypoint && (a(".fusion-counter-box").not(".fusion-modal .fusion-counter-box").each(function() {
            ...
            var b = get_waypoint_offset(a(this));
            a(this).waypoint(function() {
                a(this).fusion_recalc_circles(!0),
            ...
            a(this).waypoint(function() {
                ...
                a(this).find(".content-box-column").each(function() {
                    ...
                    setTimeout(function() {
                        ...
                        a(c).find(".fusion-animated").addClass(b),
                        d && (a(c).find(".fusion-animated").css("-moz-animation-duration", d + "s"), a(c).find(".fusion-animated").css("-webkit-animation-duration", d + "s"), a(c).find(".fusion-animated").css("-ms-animation-duration", d + "s"), a(c).find(".fusion-animated").css("-o-animation-duration", d + "s"), a(c).find(".fusion-animated").css("animation-duration", d + "s")),
                        (a(c).parents(".fusion-content-boxes").hasClass("content-boxes-timeline-horizontal") || a(c).parents(".fusion-content-boxes").hasClass("content-boxes-timeline-vertical")) && a(c).addClass("fusion-appear")
                    },
                    b),
                    b += parseInt(a(this).parents(".fusion-content-boxes").attr("data-animation-delay"))
                })
            },
            {
                triggerOnce: !0,
            ...
            a(this).waypoint(function() {
                if (!a(this).parents(".fusion-delayed-animation").length) {
                    ...
                    if (a(this).addClass(b), c) {
                        a(this).css("-moz-animation-duration", c + "s"),
                        a(this).css("-webkit-animation-duration", c + "s"),
                        a(this).css("-ms-animation-duration", c + "s"),
                        a(this).css("-o-animation-duration", c + "s"),
                        a(this).css("animation-duration", c + "s");
                        var d = a(this);
                        setTimeout(function() {
                            d.removeClass(b)
                        },
            ...
            setTimeout(function() {
                if (b.find(".fusion-nav-next").each(function() {
                    ...
                    a(b).parents(".fusion-image-carousel").length >= 1 && b.find(".fusion-image-wrapper").each(function() {
                        ...
                        a(this).find("> a").css("line-height", e - 2 + "px")
                    })
                }
            },
            5)
    ...
    a.fn.fusion_draw_circles = function() {
        ...
        f && (f = a("body").css("color")),
        c ? (b.children(".counter-circle").attr("data-percent", 100), b.children(".counter-circle").easyPieChart({
            barColor: d,
            trackColor: e,
            scaleColor: f,
            scaleLength: 5,
    ...
    a.fn.fusion_recalc_circles = function(b) {
        var c = a(this);
        if (!c.is(":hidden")) {
            c.attr("data-currentsize", c.width()),
            c.removeAttr("style"),
            ...
            e < c.data("currentsize") ? (c.css({
                ...
                a(this).data("size", e),
                a(this).data("strokesize", e / 220 * 11),
                b || a(this).data("animate", !1),
                a(this).attr("data-size", e),
                a(this).attr("data-strokesize", e / 220 * 11)
            })) : (c.css({
                width: d,
                height: d,
                "line-height": d + "px"
                ...
                a(this).data("size", d),
                a(this).data("strokesize", d / 220 * 11),
                b || a(this).data("animate", !1),
                a(this).attr("data-size", d),
                a(this).attr("data-strokesize", d / 220 * 11)
            }))
        }
    },
    ...
    a.fn.fusion_draw_progress = function() {
        ...
        a("html").hasClass("lt-ie9") ? (b.css("visibility", "visible"), b.each(function() {
            ...
            b.find(".progress").css("width", "0%"),
            b.find(".progress").animate({
                width: a + "%"
            },
            "slow")
        })) : b.find(".progress").css("width",
        function() {
    ...
    a.fn.fusion_scroller = function(b) {
        ...
        d.each(function() {
            ...
            function() {
                b = a(f).offset().top,
                a("body").hasClass("admin-bar") && (b = a(f).offset().top - a("#wpadminbar").outerHeight()),
                c.offset > 0 && (b = a(f).offset().top - c.offset),
                d = a(f).outerHeight(),
                e = b + d,
                c.end_offset && (e = a(c.end_offset).offset().top);
                ...
                if (b > g) if ("opacity" == c.type) a(f).css({
                    opacity: 1
                });
                else if ("blur" == c.type) {
                    var k = "blur(0px)";
    ...
    a.fn.fusion_switch_tab_on_link_click = function(b) {
        ...
        c && a(this).find('.nav-tabs li a[href="' + c + '"]').length && (a(this).find(".nav-tabs li").removeClass("active"), a(this).find('.nav-tabs li a[href="' + c + '"]').parent().addClass("active"), a(this).find(".tab-content .tab-pane").removeClass("in").removeClass("active"), a(this).find('.tab-content .tab-pane[id="' + d + '"]').addClass("in").addClass("active")),
        c && a(this).find('.nav-tabs li a[id="' + d + '"]').length && (a(this).find(".nav-tabs li").removeClass("active"), a(this).find('.nav-tabs li a[id="' + d + '"]').parent().addClass("active"), a(this).find(".tab-content .tab-pane").removeClass("in").removeClass("active"), a(this).find('.tab-content .tab-pane[id="' + a(this).find('.nav-tabs li a[id="' + d + '"]').attr("href").split("#")[1] + '"]').addClass("in").addClass("active"))
    },
    a.fn.equalHeights = function(b, c) {
        if (Modernizr.mq("only screen and (min-width: " + js_local_vars.content_break_point + "px)") || Modernizr.mq("only screen and (min-device-width: 768px) and (max-device-width: 1024px) and (orientation: portrait)")) {
            ...
            return this.each(function() {
                ...
                a(this).find(".fusion-column-table").css("height", "auto"),
                a(this).outerHeight() > d && (d = a(this).outerHeight())
            }),
            c && d > c && (d = c),
            this.each(function() {
                var b = d;
                "0" == b && a(this).attr("data-empty-column", "true"),
                a(this).children(".fusion-column-table").length && (b = d - (a(this).outerHeight() - a(this).height())),
                a(this).css("min-height", b),
                a(this).find(".fusion-column-table").height(b)
            })
        }
        return this.each(function() {
            a(this).css("min-height", ""),
            a(this).find(".fusion-column-table").css("height", "")
        })
    },
    a.fn.fusion_set_bg_img_dims = function() {
        a(this).each(function() {
            if (('<div class="fusion-clearfix"></div>' == a.trim(a(this).html()) || '<div class="fusion-column-table" style="height: 0px;"><div class="fusion-column-tablecell"><div class="fusion-clearfix"></div></div></div>' == a.trim(a(this).html())) && a(this).data("bg-url")) {
                ...
                b.onload = function() {
                    c = parseInt(this.height),
                    d = parseInt(this.width)
                },
                a(this).attr("data-bg-height", c),
                a(this).attr("data-bg-width", d)
            }
        })
    },
    ...
    a.fn.reinitialize_google_map = function() {
        ...
        if (b) {
            ...
            d = c.getCenter(),
            e = b.markers;
            if (google.maps.event.trigger(c, "resize"), c.setCenter(d), e) for (var f = 0; f < e.length; f++) google.maps.event.trigger(e[f], "click"),
            google.maps.event.trigger(e[f], "click")
        }
    },
        ...
        if (a(this).length) {
            ...
            c && c.each(function() {
                ...
                b && (f.length && b.hide(), b.each(function() {
                    ...
                    b.hasClass(e.substr(1)) && c.hasClass("fusion-hidden") && c.removeClass("fusion-hidden"),
                    d.length && b.hasClass(d) && (b.show(), b.find(".fusion-rollover-gallery").attr("data-rel", f.replace("gallery", d)))
                }))
            }),
    ...
    a.fn.fusion_scroll_to_anchor_target = function() {
        ...
        if (d.length && "" !== c) {
            ...
            d.hasClass("tab-link") && a(".fusion-tabs").fusion_switch_tab_on_link_click(),
            !1
        }
    }
} (jQuery),
jQuery(window).load(function() {
    ...
    300), jQuery(".fusion-modal .fusion-counter-box").each(function() {
        ...
        js_local_vars.testimonials_speed && (c.timeout = parseInt(js_local_vars.testimonials_speed)),
        c.pager = ".testimonial-pagination",
        jQuery(".fusion-testimonials .reviews").each(function() {
            1 == jQuery(this).children().length && jQuery(this).children().fadeIn(),
            c.pager = "#" + jQuery(this).parent().find(".testimonial-pagination").attr("id"),
            c.random = jQuery(this).parent().data("random"),
            jQuery(this).cycle(c)
        }),
        jQuery(window).resize(function() {
            jQuery(".fusion-testimonials .reviews").each(function() {
    ...
    if (jQuery(document).on("click", ".fusion-accordian .panel-title a",
    function(a) {
        a.preventDefault();
        var b = jQuery(this),
        ...
        b.hasClass("active") ? b.parents(".fusion-accordian ").find(".panel-title a").removeClass("active") : (b.parents(".fusion-accordian ").find(".panel-title a").removeClass("active"), b.addClass("active"), setTimeout(function() {
            ...
            c.find(".fusion-carousel").length && generate_carousel(),
            c.find(".fusion-portfolio").each(function() {
                jQuery(this).find(".fusion-portfolio-wrapper").isotope()
            }),
            c.find(".flexslider, .rev_slider_wrapper, .ls-container").length && jQuery(window).trigger("resize"),
            c.find(".flip-box-inner-wrapper").each(function() {
                jQuery(this).fusion_calc_flip_boxes_height()
            }),
            c.find(".fusion-blog-shortcode").each(function() {
                ...
                jQuery(this).find(".fusion-blog-layout-grid").find(".fusion-post-grid").css("width", b),
    ...
    }), jQuery(".fusion-modal").bind("hidden.bs.modal",
    function() {
        jQuery("html").css("overflow", "")
    }), jQuery(".fusion-modal").bind("show.bs.modal",
    function() {
    ...
    }), jQuery("[data-toggle=modal]").on("click",
    function(a) {
        a.preventDefault()
    ...
    function() {
        ...
        jQuery(this).parents(".fusion-header-wrapper").length ? $container = ".fusion-header-wrapper": jQuery(this).parents("#side-header").length ? $container = "#side-header": $container = "body",
        jQuery(this).tooltip({
            container: $container
        })
    }), jQuery(".fusion-tooltip").hover(function() {
        var a = jQuery(this).attr("title");
        jQuery(this).attr("data-title", a),
        jQuery(this).attr("title", "")
    }), jQuery(".fusion-tooltip").click(function() {
        var a = jQuery(this).attr("data-title");
        jQuery(this).attr("title", a),
        jQuery(this).blur()
    }), jQuery(".tribe_events_filters_close_filters, .tribe_events_filters_show_filters").on("click",
    function() {
        var a = jQuery(this);
        setTimeout(function() {
    ...
    }), jQuery(".fusion-layout-column .fusion-column-wrapper").fusion_set_bg_img_dims(), jQuery(".fusion-layout-column .fusion-column-wrapper").fusion_calculate_empty_column_height(), jQuery(window).on("resize",
    function() {
...
jQuery(document).ajaxComplete(function() {
    jQuery(".wpcf7-response-output").each(function() {
        ...
        jQuery(this).hasClass("wpcf7-mail-sent-ok") && !jQuery(this).find(".alert-icon").length && (jQuery(this).addClass("fusion-alert"), jQuery("body").hasClass("rtl") ? jQuery(this).append('<button class="close toggle-alert" aria-hidden="true" data-dismiss="alert" type="button">&times;</button><span class="alert-icon"><i class="fa fa-lg fa-check-circle"></i></span>') : jQuery(this).prepend('<button class="close toggle-alert" aria-hidden="true" data-dismiss="alert" type="button">&times;</button><span class="alert-icon"><i class="fa fa-lg fa-check-circle"></i></span>'))
    }),
...
jQuery(document).ready(function(a) {
    ...
    if (add_styles_for_old_ie_versions(), jQuery("body").fusion_deactivate_mobile_image_hovers(), jQuery(window).on("resize",
    function() {
    ...
    }), jQuery(".fusion-footer-parallax").fusion_footer_parallax(), jQuery(window).on("resize",
    function() {
        ...
        d.indexOf("underline") > -1 && (e = d),
        jQuery("body").hasClass("rtl") ? jQuery(".comment-respond .comment-reply-title").addClass("title-heading-right") : jQuery(".comment-respond .comment-reply-title").addClass("title-heading-left"),
        $styles = ' style="margin-top:' + js_local_vars.title_margin_top + ";margin-bottom:" + js_local_vars.title_margin_bottom + ';"',
        jQuery(".comment-respond .comment-reply-title").wrap('<div class="fusion-title title fusion-title-size-three' + d + '"' + $styles + "></div>"),
        -1 == d.indexOf("underline") && jQuery(".comment-respond .comment-reply-title").parent().append('<div class="title-sep-container"><div class="title-sep' + d + ' "></div></div>')
    }
    ...
    jQuery().UItoTop && (cssua.ua.mobile && "1" == js_local_vars.status_totop_mobile ? jQuery().UItoTop({
    ...
    jQuery(window).on("resize",
    function() {
        jQuery(".demo_store").length && (jQuery("#wrapper").css("margin-top", jQuery(".demo_store").outerHeight()), jQuery(".sticky-header").length && jQuery(".sticky-header").css("margin-top", jQuery(".demo_store").outerHeight())),
        jQuery(".sticky-header").length && (jQuery(window).width() < 765 ? jQuery("body.admin-bar #header-sticky.sticky-header").css("top", "46px") : jQuery("body.admin-bar #header-sticky.sticky-header").css("top", "32px"))
    }),
    "classic" == js_local_vars.mobile_menu_design && (jQuery(".sh-mobile-nav-holder").append('<div class="mobile-selector"><span>' + js_local_vars.dropdown_goto + "</span></div>"), jQuery(".sh-mobile-nav-holder .mobile-selector").append('<div class="selector-down"></div>')),
    ...
    jQuery(".sh-mobile-nav-holder ul#mobile-nav").find("li").each(function() {
        var a = "mobile-nav-item"; (jQuery(this).hasClass("current-menu-item") || jQuery(this).hasClass("current-menu-parent") || jQuery(this).hasClass("current-menu-ancestor")) && (a += " mobile-current-nav-item"),
        jQuery(this).attr("class", a),
        jQuery(this).attr("id") && jQuery(this).attr("id", jQuery(this).attr("id").replace("menu-item", "mobile-menu-item")),
        jQuery(this).attr("style", "")
    }),
    ...
    1 == js_local_vars.submenu_slideout && (jQuery(".header-wrapper .mobile-topnav-holder .mobile-topnav li, .header-wrapper .mobile-nav-holder .navigation li, .sticky-header .mobile-nav-holder .navigation li, .sh-mobile-nav-holder .navigation li").each(function() {
        var a = "mobile-nav-item"; (jQuery(this).hasClass("current-menu-item") || jQuery(this).hasClass("current-menu-parent") || jQuery(this).hasClass("current-menu-ancestor") || jQuery(this).hasClass("mobile-current-nav-item")) && (a += " mobile-current-nav-item"),
        jQuery(this).attr("class", a),
        jQuery(this).find(" > ul").length && (jQuery(this).prepend('<span href="#" aria-haspopup="true" class="open-submenu"></span>'), jQuery(this).find(" > ul").hide())
    ...
    jQuery(window).load(function() {
        i = get_adminbar_height(),
        j = get_sticky_header_height(),
        jQuery("body").data()["bs.scrollspy"].options.offset = parseInt(i + j + 1)
    }),
    jQuery('.fusion-menu a:not([href="#"], .fusion-megamenu-widgets-container a, .search-link), .fusion-mobile-nav-item a:not([href="#"], .search-link), .fusion-button:not([href="#"], input, button), .fusion-one-page-text-link:not([href="#"])').click(function(a) {
        if (this.hash) {
            ...
            "/" != g && (f += "/"),
            a.preventDefault(),
            location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") || "#" == c.charAt(0) ? jQuery(this).fusion_scroll_to_anchor_target() : window.location = f + "#_" + e
        }
    }),
    ...
    ("ontouchstart" in document.documentElement || navigator.msMaxTouchPoints) && (jQuery(".fusion-main-menu li.menu-item-has-children > a, .fusion-secondary-menu li.menu-item-has-children > a, .order-dropdown > li .current-li").on("click",
    function(a) {
        var b = jQuery(this);
    ...
    }), jQuery(".sub-menu li, .fusion-mobile-nav-item li").not("li.menu-item-has-children").on("click",
    function(a) {
    ...
    jQuery(".megaResponsive").length >= 1 && jQuery(".mobile-nav-holder.main-menu").addClass("set-invisible"),
    "" !== js_local_vars.language_flag && jQuery(".search-field, .searchform").each(function() {
    ...
    jQuery(".wpcf7-form .wpcf7-submit").on("click",
    function() {
    ...
    "Top" == js_local_vars.header_position && jQuery(window).on("resize",
    function() {
    ...
    jQuery(".nav-tabs li").click(function(a) {
        ...
        if (b.parents(".fusion-tabs").find(".nav li").removeClass("active"), b.parents(".fusion-tabs").find(c).find(".fusion-woo-slider").length) {
            var d = 0;
            b.parents(".fusion-tabs").hasClass("horizontal-tabs") && (d = b.parents(".fusion-tabs").find(".nav").height()),
            b.parents(".fusion-tabs").height(b.parents(".fusion-tabs").find(".tab-content").outerHeight(!0) + d)
        }
        setTimeout(function() {
            b.parents(".fusion-tabs").find(c).find(".shortcode-map").each(function() {
                jQuery(this).reinitialize_google_map()
            }),
            b.parents(".fusion-tabs").find(c).find(".fusion-carousel").length && generate_carousel(),
            b.parents(".fusion-tabs").find(c).find(".fusion-portfolio").each(function() {
            ...
            jQuery(window).trigger("resize"),
            b.parents(".fusion-tabs").find(c).find(".flip-box-inner-wrapper").each(function() {
                jQuery(this).fusion_calc_flip_boxes_height()
            }),
            b.parents(".fusion-tabs").find(c).find(".fusion-woo-slider").length && b.parents(".fusion-tabs").css("height", ""),
            jQuery(".crossfade-images").each(function() {
                fusion_resize_crossfade_images_container(jQuery(this)),
                fusionResizeCrossfadeImages(jQuery(this))
            }),
    ...
    jQuery(".tabs-widget .tabset li").click(function(a) {
        ...
        jQuery(this).parents(".tabs-widget").find(b).fadeIn()
    }),
    ...
    jQuery(".fusion-portfolio .fusion-filters a").click(function(a) {
        ...
        jQuery(this).parents(".fusion-portfolio").find(".fusion-portfolio-wrapper").find(".fusion-portfolio-post").each(function() {
            ...
            f = "iLightbox[gallery" + a + d + "]"; (jQuery(this).hasClass(e) || 1 == b.length) && (b.length > 1 && -1 === jQuery.inArray(e + a + d, c) ? c.push(e + a + d) : 1 === b.length && -1 === jQuery.inArray(a + d, c) && c.push("gallery" + a + d), jQuery(this).find(".fusion-rollover-gallery").attr("data-rel", f), jQuery(this).find(".fusion-portfolio-gallery-hidden a").attr("data-rel", f))
        }),
        "created" != jQuery(this).data("lightbox") && (jQuery.each(c,
        function(a, b) {
    ...
    jQuery(".fusion-faqs, .fusion-faq-shortcode").each(function() {
        ...
        if (jQuery(".fusion-faqs-wrapper").fadeIn(), b.length) {
            ...
            c && c.each(function() {
                ...
                f && (e.length && f.hide(), f.each(function() {
                    var c = jQuery(this);
                    c.hasClass(b.substr(1)) && a.hasClass("fusion-hidden") && a.removeClass("fusion-hidden"),
                    e.length && c.hasClass(e) && c.show()
                }))
            })
        }
        a.find(".fusion-filters a").click(function(b) {
            ...
            a.find(".fusion-faqs-wrapper .fusion-faq-post").fadeOut(),
            setTimeout(function() {
    ...
    Modernizr.mq("only screen and (max-width: 479px)") && (jQuery(".overlay-full.layout-text-left .slide-excerpt p").each(function() {
        ...
        b(a) === !0 && jQuery(this).parents(".fusion-image-wrapper").find("> img").attr("src", a).attr("width", "").attr("height", ""),
    ...
    Modernizr.mq("only screen and (max-width: " + js_local_vars.content_break_point + "px)") && jQuery(".tabs-vertical").addClass("tabs-horizontal").removeClass("tabs-vertical"),
    jQuery(window).on("resize",
    function() {
    ...
    Modernizr.mq("only screen and (max-width: " + js_local_vars.content_break_point + "px)") && jQuery(".fullwidth-faded").each(function() {
        ...
        jQuery(this).parent().css("background-image", a),
        jQuery(this).remove()
    }),
    jQuery(".gform_wrapper").each(function() {
        jQuery(this).removeClass("gf_browser_ie")
    }),
    jQuery(".link-area-box").on("click",
    function() {
...
var YT_ready = function() {
    ...
    b = !1;
    return function(c, d) {
        if (c === !0) for (b = !0; a.length;) a.shift()();
...
if (orig_logo_container_margin_top || (orig_logo_container_margin_top = "0px"), orig_logo_container_margin_bottom || (orig_logo_container_margin_bottom = "0px"), jQuery(window).load(function() {
    ...
    if (jQuery(".sidebar").is(":visible") && jQuery(".post-content .fusion-portfolio").each(function() {
            ...
            c && c.each(function() {
                ...
                g && (f.length && g.hide(), jQuery(".fusion-filters").show(), g.each(function() {
                    ...
                    if (c.hasClass(b.substr(1)) && a.hasClass("fusion-hidden") && a.removeClass("fusion-hidden"), f.length && c.hasClass(f) && (c.show(), d)) {
                        ...
                        c.find(".fusion-rollover-gallery").attr("data-rel", e),
                        -1 === jQuery.inArray(e, h) && h.push(e)
                    }
                }))
            }),
            f.length && (a = "." + f, jQuery.each(h,
            function(a, b) {
        ...
        jQuery(this).imagesLoaded().progress(function(a, b) {
        ...
        jQuery(".tfs-slider").each(function() {
            ...
            if (jQuery(a).parents("#sliders-container").length >= 1 && 1 === jQuery(a).data("parallax") && jQuery(".fusion-header").addClass("fusion-header-backface"), 1 == jQuery(a).data("full_screen")) {
                ...
                jQuery(a).find("video").each(function() {
                    ...
                    jQuery(a).parents(".post-content").length && (f = jQuery(a).width()),
                    f > c ? (c = "100%", d = 0, $position = "static") : $position = "absolute",
                    jQuery(this).width(c),
                    jQuery(this).css({
                        left: d,
                        position: $position
                ...
                if ( - 1 != f.indexOf("%")) {
                    f = jQuery(c).find(".background-image").data("imgwidth"),
                    f || cssua.ua.mobile || (f = jQuery(c).find("video").width()),
                    f || (f = 940),
                    jQuery(a).data("first_slide_width", f),
                    f < jQuery(a).data("slider_width") && (f = jQuery(a).data("slider_width"))
                ...
                var e = g * h;
                e > parseInt(jQuery(a).data("slider_height")) && (e = parseInt(jQuery(a).data("slider_height"))),
                200 > e && (e = 200)
            }
            if (1 == jQuery(a).data("full_screen") && (jQuery(a).css("max-width", "100%"), jQuery(a).find(".slides, .background").css("width", "100%")), "Left" != js_local_vars.header_position && "Right" != js_local_vars.header_position || jQuery(a).hasClass("fixed-width-slider") || 1 != jQuery(a).data("parallax") || (jQuery(a).css("max-width", jQuery("#wrapper").width()), jQuery("body").hasClass("side-header-left") ? jQuery(a).css("left", jQuery("#side-header").width() + 1) : jQuery("body").hasClass("side-header-right") && jQuery(a).css("right", jQuery("#side-header").width() + 1)), jQuery(a).parents(".fusion-slider-container").css("height", e), jQuery(a).css("height", e), jQuery(a).find(".background, .mobile_video_image").css("height", e), jQuery(".layout-boxed-mode").length >= 1) {
                ...
                jQuery(a).css("width", i),
                jQuery(a).css("margin-left", "auto"),
                jQuery(a).css("margin-right", "auto"),
                1 != jQuery(a).data("parallax") || Modernizr.mq("only screen and (max-width: " + js_local_vars.side_header_break_point + "px)") || (jQuery(a).css("left", "50%"), "Left" == js_local_vars.header_position || "Right" == js_local_vars.header_position ? (i = jQuery(".layout-boxed-mode #wrapper").width() - jQuery(".layout-boxed-mode #side-header").width(), "Right" == js_local_vars.header_position && (i = jQuery(".layout-boxed-mode #wrapper").width() + jQuery(".layout-boxed-mode #side-header").width()), jQuery(a).css("margin-left", "-" + Math.floor(i / 2) + "px")) : jQuery(a).css("margin-left", "-" + i / 2 + "px")),
                jQuery(a).find(".slides, .background").css("width", "100%")
            }
            ...
            function() {
                if (jQuery(window).width() != k || jQuery(window).height() != l) {
                    ...
                    if (1 == jQuery(a).data("full_screen")) {
                        ...
                        if (1 == js_local_vars.header_transparency) if (Modernizr.mq("only screen and (max-width: " + js_local_vars.side_header_break_point + "px)") && "above" != js_local_vars.slider_position) var d = jQuery(window).height() - (b + c);
                        ...
                        setTimeout(function() {
                            jQuery(a).find("video").each(function() {
                                ...
                                f = jQuery(a).parent().parent().parent().width();
                                jQuery(a).parents(".post-content").length && (f = jQuery(a).width()),
                                f > c ? (c = "100%", e = 0, $position = "static") : $position = "absolute",
                                jQuery(this).width(c),
                                jQuery(this).css({
                                    left: e,
                                    position: $position
                        ...
                        var f = jQuery(a).data("slider_width");
                        if ( - 1 != f.indexOf("%")) {
                            f = jQuery(a).data("first_slide_width"),
                            f < jQuery(a).data("slider_width") && (f = jQuery(a).data("slider_width"));
                            var g = !0
                        } else f = parseInt(jQuery(a).data("slider_width"));
                        ...
                        var d = h * i;
                        d > parseInt(jQuery(a).data("slider_height")) && (d = parseInt(jQuery(a).data("slider_height"))),
                        200 > d && (d = 200),
                        jQuery(a).find("video").each(function() {
                            var b = jQuery(this).width() / jQuery(this).height(),
                            c = b * d;
                            ...
                            jQuery(a).parents(".post-content").length >= 1 && (h = jQuery(a).width()),
                            h > c && g === !0 && 1 != jQuery(a).data("full_screen") && (c = "100%", e = 0),
                            jQuery(this).width(c),
                    ...
                    if (Modernizr.mq("only screen and (max-width: " + js_local_vars.content_break_point + "px)") ? jQuery(a).find(".fusion-button").each(function() {
                        ...
                        jQuery(a).css("width", j),
                        jQuery(a).css("margin-left", "auto"),
                        jQuery(a).css("margin-right", "auto"),
                        1 != jQuery(a).data("parallax") || Modernizr.mq("only screen and (max-width: " + js_local_vars.side_header_break_point + "px)") || (jQuery(a).css("left", "50%"), "Left" == js_local_vars.header_position || "Right" == js_local_vars.header_position ? (j = jQuery(".layout-boxed-mode #wrapper").width() - jQuery(".layout-boxed-mode #side-header").width(), "Right" == js_local_vars.header_position && (j = jQuery(".layout-boxed-mode #wrapper").width() + jQuery(".layout-boxed-mode #side-header").width()), jQuery(a).css("margin-left", "-" + Math.floor(j / 2) + "px")) : jQuery(a).css("margin-left", "-" + j / 2 + "px")),
                        "slide" != jQuery(a).data("animation") && jQuery(a).find(".slides").css("width", "100%"),
                        jQuery(a).find(".background").css("width", "100%")
                    }
                    if (1 !== jQuery(a).data("parallax") || Modernizr.mq("only screen and (max-width: " + js_local_vars.side_header_break_point + "px)")) {
                        ...
                        if (jQuery(a).find(".flex-direction-nav li a").css("-webkit-transform", n), jQuery(a).find(".flex-direction-nav li a").css("-ms-transform", n), jQuery(a).find(".flex-direction-nav li a").css("-o-transform", n), jQuery(a).find(".flex-direction-nav li a").css("-moz-transform", n), jQuery(a).find(".flex-direction-nav li a").css("transform", n), jQuery("#main, .fusion-footer-widget-area, .fusion-footer-copyright-area, .fusion-page-title-bar").css("position", "relative"), jQuery("#main, .fusion-footer-widget-area, .fusion-footer-copyright-area, .fusion-page-title-bar").css("z-index", "3"), jQuery(".fusion-header-wrapper").css("z-index", "5"), jQuery(".fusion-header-wrapper").css("height", b), jQuery(a).hasClass("fixed-width-slider")) {
                            ...
                            jQuery(a).css("left", "50%"),
                            jQuery(a).css("margin-left", p)
                        }
                    ...
                    Modernizr.mq("only screen and (max-width: " + js_local_vars.side_header_break_point + "px)") && jQuery(".fusion-header-wrapper").css("height", ""),
                    k = jQuery(window).width(),
                    l = jQuery(window).height()
                }
            }),
            jQuery(a).parents(".post-content").length >= 1 && (jQuery(a).css("max-width", "100%"), "slide" != jQuery(a).data("animation") && jQuery(a).find(".slides").css("max-width", "100%")),
            jQuery(a).find("video").each(function() {
                "function" == typeof jQuery(this)[0].pause && jQuery(this)[0].pause()
            }),
            jQuery(a).flexslider({
                ...
                start: function(d) {
                    ...
                    jQuery(d.slides.eq(d.currentSlide)).find(".slide-content-container").show(),
                    jQuery(d.slides.eq(d.currentSlide)).find(".fusion-title").fusion_responsive_title_shortcode();
                    ...
                    if (f += 40, 1 == jQuery(a).data("full_screen")) {
                        ...
                        jQuery(a).find("video").each(function() {
                            ...
                            jQuery(a).parents(".post-content").length >= 1 && (e = jQuery(a).width()),
                            e > c && (c = "100%", d = 0),
                            jQuery(this).width(c),
                            jQuery(this).css("left", d)
                        })
                    } else {
                        var i = jQuery(a).data("slider_width");
                        if ( - 1 != i.indexOf("%")) {
                            i = jQuery(c).find(".background-image").data("imgwidth"),
                            i || cssua.ua.mobile || (i = jQuery(c).find("video").width()),
                            i || (i = 940),
                            jQuery(a).data("first_slide_width", i),
                            i < jQuery(a).data("slider_width") && (i = jQuery(a).data("slider_width"));
                            var j = !0
                        ...
                        var g = k * l;
                        g > parseInt(jQuery(a).data("slider_height")) && (g = parseInt(jQuery(a).data("slider_height"))),
                        200 > g && (g = 200),
                        f > g && (g = f),
                        jQuery(a).find("video").each(function() {
                            var b = jQuery(this).width() / jQuery(this).height(),
                            ...
                            e = jQuery(a).parent().parent().parent().width();
                            jQuery(a).parents(".post-content").length >= 1 && (e = jQuery(a).width()),
                            e > c && j === !0 && 1 != jQuery(a).data("full_screen") && (c = "100%", d = 0),
                            jQuery(this).width(c),
                            jQuery(this).css("left", d)
                        })
                    }
                    ...
                    "undefined" != typeof d.slides && 0 !== d.slides.eq(d.currentSlide).find("iframe").length && (Number(js_local_vars.status_vimeo) && ($f(d.slides.eq(d.currentSlide).find("iframe")[0]).api("pause"), "yes" == jQuery(d.slides.eq(d.currentSlide)).data("autoplay") && $f(d.slides.eq(d.currentSlide).find("iframe")[0]).api("play"), "yes" == jQuery(d.slides.eq(d.currentSlide)).data("mute") && $f(d.slides.eq(d.currentSlide).find("iframe")[0]).api("setVolume", 0)), playVideoAndPauseOthers(d)),
                    jQuery(a).find(".overlay-link").hide(),
                    jQuery(d.slides.eq(d.currentSlide)).find(".overlay-link").show(),
                ...
                before: function(b) {
                    jQuery(a).find(".slide-content-container").hide(),
                    0 !== b.slides.eq(b.currentSlide).find("iframe").length && Number(js_local_vars.status_vimeo) && (jQuery(a).find("iframe").each(function() {
                        $f(jQuery(this)[0]).api("pause")
                    }), "yes" == jQuery(b.slides.eq(b.currentSlide)).data("autoplay") && $f(b.slides.eq(b.currentSlide).find("iframe")[0]).api("play"), "yes" == jQuery(b.slides.eq(b.currentSlide)).data("mute") && $f(b.slides.eq(b.currentSlide).find("iframe")[0]).api("setVolume", 0)),
                    playVideoAndPauseOthers(b)
                },
                after: function(b) {
                    jQuery(b.slides.eq(b.currentSlide)).find(".slide-content-container").show(),
                    jQuery(b.slides.eq(b.currentSlide)).find(".fusion-title").fusion_responsive_title_shortcode();
                    var c = jQuery(a).find(".slide-content-container");
                    fusion_reanimate_slider(c),
                    0 !== b.slides.eq(b.currentSlide).find("iframe").length && Number(js_local_vars.status_vimeo) && (jQuery(a).find("iframe").each(function() {
                        $f(jQuery(this)[0]).api("pause")
                    }), "yes" == jQuery(b.slides.eq(b.currentSlide)).data("autoplay") && $f(b.slides.eq(b.currentSlide).find("iframe")[0]).api("play"), "yes" == jQuery(b.slides.eq(b.currentSlide)).data("mute") && $f(b.slides.eq(b.currentSlide).find("iframe")[0]).api("setVolume", 0)),
                    jQuery(a).find(".overlay-link").hide(),
                    jQuery(b.slides.eq(b.currentSlide)).find(".overlay-link").show(),
        ...
        "false" === js_local_vars.page_smoothHeight ? page_smoothHeight = !1 : page_smoothHeight = !0,
        jQuery(".fusion-blog-layout-grid .flexslider").flexslider({
            ...
            start: function(a) {
                ...
                "undefined" != typeof a.slides && 0 !== a.slides.eq(a.currentSlide).find("iframe").length ? (Number(js_local_vars.pagination_video_slide) ? jQuery(a).find(".flex-control-nav").css("bottom", "-20px") : jQuery(a).find(".flex-control-nav").hide(), Number(js_local_vars.status_yt) && window.yt_vid_exists === !0 && YT_ready(function() {
                ...
                })) : Number(js_local_vars.pagination_video_slide) ? jQuery(a).find(".flex-control-nav").css("bottom", "0px") : jQuery(a).find(".flex-control-nav").show(),
                jQuery.waypoints("viewportHeight"),
                jQuery.waypoints("refresh")
            },
            before: function(a) {
        ...
        "false" === js_local_vars.flex_smoothHeight ? flex_smoothHeight = !1 : flex_smoothHeight = !0,
    ...
    jQuery().isotope && jQuery(".fusion-blog-layout-grid").each(function() {
        ...
        if ($grid_container.find(".fusion-post-grid").css("width", b), $grid_container.isotope({
            ...
            $grid_container.find(".fusion-post-grid").css("width", b),
    ...
    if (jQuery().flexslider && jQuery(".woocommerce .images #carousel").length >= 1) {
        jQuery("body.woocommerce .sidebar").is(":visible") ? wooThumbWidth = 100 : wooThumbWidth = 118,
        "undefined" != typeof jQuery(".woocommerce .images #carousel").data("flexslider") && (jQuery(".woocommerce .images #carousel").flexslider("destroy"), jQuery(".woocommerce .images #slider").flexslider("destroy")),
    ...
    if ("Click" == js_local_vars.sidenav_behavior ? jQuery(".side-nav li a").on("click",
    function(a) {
        return jQuery(this).parent(".page_item_has_children").length && (jQuery(this).parent().find("> .children").length && !jQuery(this).parent().find("> .children").is(":visible") ? jQuery(this).parent().find("> .children").stop(!0, !0).slideDown("slow") : jQuery(this).parent().find("> .children").stop(!0, !0).slideUp("slow")),
        jQuery(this).parent(".page_item_has_children.current_page_item").length ? !1 : void 0
        ...
        js_local_vars.tfes_animation && (a.animation = js_local_vars.tfes_animation),
        js_local_vars.tfes_interval && (a.slideshow_interval = js_local_vars.tfes_interval),
        js_local_vars.tfes_speed && (a.speed = js_local_vars.tfes_speed),
        js_local_vars.tfes_width && (a.thumbMaxWidth = js_local_vars.tfes_width),
        jQuery("#ei-slider").eislideshow(a)
    }
    ...
    jQuery(".fusion-posts-container-infinite").each(function() {
        ...
        jQuery(this).find(".fusion-blog-layout-timeline").length && (a = jQuery(this).find(".fusion-blog-layout-timeline")),
        $parent_wrapper_classes = "",
        a.parents(".fusion-blog-shortcode").length && ($parent_wrapper_classes = "." + a.parents(".fusion-blog-shortcode").attr("class").replace(/\ /g, ".") + " "),
        jQuery(a).infinitescroll({
        ...
        function(e) {
            ...
            10), jQuery(a).find(".fusion-timeline-date").unbind("click"), jQuery(a).find(".fusion-timeline-date").click(function() {
                ...
                jQuery(a).find(".post").css("width", g),
                imagesLoaded(e,
                function() {
                    jQuery(e).fadeIn(),
                    jQuery(a).hasClass("isotope") && (jQuery(a).isotope("appended", jQuery(e)), jQuery(a).isotope()),
                    jQuery('[data-spy="scroll"]').each(function() {
                        jQuery(this).scrollspy("refresh")
                    })
                })
            ...
            $fusion_posts_container = a,
            jQuery(a).hasClass("fusion-blog-layout-timeline") && ($fusion_posts_container = jQuery(a).parents(".fusion-posts-container-infinite")),
            $current_page = $fusion_posts_container.find(".current").html(),
            $fusion_posts_container.find(".current").remove(),
            $fusion_posts_container.data("pages") == $current_page && ($fusion_posts_container.parent().find(".fusion-loading-container").hide(), $fusion_posts_container.parent().find(".fusion-load-more-button").hide()),
            "individual" != js_local_vars.lightbox_behavior && d.find(".fusion-post-slideshow").length || ($avada_lightbox.activate_lightbox(jQuery(e)), d = a.find(".post")),
            $avada_lightbox.refresh_lightbox()
        }),
        (jQuery(a).hasClass("fusion-blog-archive") && "load_more_button" == js_local_vars.blog_pagination_type || jQuery(a).hasClass("fusion-posts-container-load-more") || jQuery(a).hasClass("fusion-blog-layout-timeline") && jQuery(a).parent().hasClass("fusion-posts-container-load-more")) && (jQuery(a).infinitescroll("unbind"), jQuery(a).hasClass("fusion-blog-archive") ? $load_more_button = jQuery(a).parent().find(".fusion-load-more-button") : $load_more_button = jQuery(a).parents(".fusion-blog-archive").find(".fusion-load-more-button"), $load_more_button.on("click",
        function(b) {
            b.preventDefault(),
            jQuery(a).infinitescroll("retrieve"),
            jQuery(a).hasClass("fusion-blog-layout-grid") && jQuery(a).isotope()
        })),
        $fusion_posts_container = a,
        jQuery(a).hasClass("fusion-blog-layout-timeline") && jQuery(a).parents(".fusion-blog-layout-timeline-wrapper").length && ($fusion_posts_container = jQuery(a).parents(".fusion-posts-container-infinite")),
        "1" == $fusion_posts_container.data("pages") && ($fusion_posts_container.parent().find(".fusion-loading-container").hide(), $fusion_posts_container.parent().find(".fusion-load-more-button").hide())
    }),
        ...
        if (jQuery().isotope) {
            ...
            function() {
                ...
                if (d.each(function() {
                    ...
                    a && a.each(function() {
                        if ($post = jQuery(this), $post.hasClass(c.substr(1)) && b.hasClass("fusion-hidden")) if (Modernizr.mq("only screen and (max-width: " + js_local_vars.content_break_point + "px)")) b.fadeIn(400,
                        function() {
                ...
                $infinte_scroll_container.isotope("appended", a),
                a.each(function() {
                    jQuery(this).find(".full-video, .video-shortcode, .wooslider .slide-content").fitVids()
                }),
                jQuery('[data-spy="scroll"]').each(function() {
                ...
                $infinte_scroll_container.data("pages") == $current_page && ($infinte_scroll_container.parent().find(".fusion-loading-container").hide(), $infinte_scroll_container.parent().find(".fusion-load-more-button").hide())
            })
        }
    }), "1" == $infinte_scroll_container.data("pages") && ($infinte_scroll_container.parent().find(".fusion-loading-container").hide(), $infinte_scroll_container.parent().find(".fusion-load-more-button").hide()), "load_more_button" == js_local_vars.portfolio_pagination_type && ($infinte_scroll_container.infinitescroll("unbind"), jQuery(".fusion-portfolio").find(".fusion-load-more-button").on("click",
    function(a) {
        a.preventDefault(),
